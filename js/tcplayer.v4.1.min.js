!
function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e(require("hls.js"), require("dashjs"), require("flv.js")) : "function" == typeof define && define.amd ? define(["hls.js", "dashjs", "flv.js"], e) : t.TCPlayer = e(t.Hls, t.dashjs, t.flvjs)
} (this,
function(t, e, n) {
    function r(t, e) {
        return e = {
    ...
    function s(t, e) {
        ...
        return ri(t).reduce(function(n, i) {
            return e(n, t[i], i)
        },
        n)
    }
    ...
    function l(t) {
        return !! t && "object" === (void 0 === t ? "undefined": Jn(t))
    }
    function c(t) {
        return l(t) && "[object Object]" === ii.call(t) && t.constructor === Object
    }
    function u(t) {
    ...
    function p(t, e) {
        if (!t || !e) return "";
        if ("function" == typeof tn.getComputedStyle) {
            var n = tn.getComputedStyle(t);
            return n ? n[e] : ""
        }
    ...
    function g() {
        return sn === tn.document && "undefined" != typeof sn.createElement
    }
    function v(t) {
    ...
    function _(t) {
        return function(e, n) {
            if (!d(e)) return sn[t](null);
            d(n) && (n = sn.querySelector(n));
            var i = v(n) ? n: sn;
            return i[t] && i[t](e)
        }
    }
    function b() {
        ...
        i = arguments[3],
        r = sn.createElement(t);
        return Object.getOwnPropertyNames(e).forEach(function(t) {
            var n = e[t]; - 1 !== t.indexOf("aria-") || "role" === t || "type" === t ? (ci.warn(ui(hi, t, n)), r.setAttribute(t, n)) : "textContent" === t ? T(r, n) : r[t] = n
        }),
    ...
    function E(t, e) {
        return f(e),
        t.classList ? t.classList.contains(e) : y(e).test(t.className)
    }
    function w(t, e) {
        return t.classList ? t.classList.add(e) : E(t, e) || (t.className = (t.className + " " + e).trim()),
        t
    }
    function k(t, e) {
        return t.classList ? t.classList.remove(e) : (f(e), t.className = t.className.split(/\s+/).filter(function(t) {
            return t !== e
        }).join(" ")),
        t
    }
    function S(t, e, n) {
        var i = E(t, e);
        if ("function" == typeof n && (n = n(t, e)), "boolean" != typeof n && (n = !i), n !== i) return n ? w(t, e) : k(t, e),
        t
    }
    function I(t, e) {
    ...
    function P(t) {
        ...
        i = n.length - 1; i >= 0; i--) {
            var r = n[i].name,
            o = n[i].value;
            "boolean" != typeof t[r] && -1 === ",autoplay,controls,playsinline,loop,muted,default,defaultMuted,".indexOf("," + r + ",") || (o = null !== o),
            e[r] = o
        }
        return e
    }
    ...
    function O(t) {
        if (t && t.getBoundingClientRect && t.parentNode) {
            ...
            n.height || (n.height = parseFloat(p(t, "height"))),
            n.width || (n.width = parseFloat(p(t, "width"))),
            n
        }
    }
    function j(t) {
        ...
        var n = sn.documentElement,
        i = sn.body,
        r = n.clientLeft || i.clientLeft || 0,
        o = tn.pageXOffset || i.scrollLeft,
        s = e.left + o - r,
        a = n.clientTop || i.clientTop || 0,
        l = tn.pageYOffset || i.scrollTop,
        c = e.top + l - a;
        return {
            left: Math.round(s),
            top: Math.round(c)
    ...
    function F(t) {
        ...
        (Array.isArray(t) ? t: [t]).map(function(t) {
            return "function" == typeof t && (t = t()),
            v(t) || N(t) ? t: "string" == typeof t && /\S/.test(t) ? sn.createTextNode(t) : void 0
        }).filter(function(t) {
            return t
        })
    }
    ...
    function U(t) {
        return t.button === undefined && t.buttons === undefined || (0 === t.button && t.buttons === undefined || (9 === Dn || 0 === t.button && 1 === t.buttons))
    }
    function q() {
        return yi++
    }
    ...
    function W(t) {
        var e = t[vi];
        return !! e && !!Object.getOwnPropertyNames(gi[e]).length
    }
    function K(t) {
        var e = t[vi];
        if (e) {
            ...
            try {
                ...
                t.removeAttribute ? t.removeAttribute(vi) : t[vi] = null
            }
        }
    }
    function Q(t, e) {
        ...
        0 === Object.getOwnPropertyNames(n).length && K(t)
    }
    function X(t, e, n, i) {
    ...
    function $(t) {
        ...
        if (!t || !t.isPropagationStopped) {
            var i = t || tn.event;
            t = {};
            for (var r in i)"layerX" !== r && "layerY" !== r && "keyLocation" !== r && "webkitMovementX" !== r && "webkitMovementY" !== r && ("returnValue" === r && i.preventDefault || (t[r] = i[r]));
            if (t.target || (t.target = t.srcElement || sn), t.relatedTarget || (t.relatedTarget = t.fromElement === t.target ? t.toElement: t.fromElement), t.preventDefault = function() {
    ...
    function G(t, e, n) {
        ...
        var i = z(t);
        if (i.handlers || (i.handlers = {}), i.handlers[e] || (i.handlers[e] = []), n.guid || (n.guid = q()), i.handlers[e].push(n), i.dispatcher || (i.disabled = !1, i.dispatcher = function(e, n) {
            if (!i.disabled) {
                e = $(e);
                var r = i.handlers[e.type];
                if (r) for (var o = r.slice(0), s = 0, a = o.length; s < a && !e.isImmediatePropagationStopped(); s++) try {
                    o[s].call(t, e, n)
                } catch(l) {
                    ci.error(l)
                }
            ...
            t.addEventListener(e, i.dispatcher, r)
    ...
    function Y(t, e, n) {
        if (W(t)) {
            var i = z(t);
            if (i.handlers) {
                if (Array.isArray(e)) return X(Y, t, e, n);
                var r = function(t, e) {
                    i.handlers[e] = [],
                    Q(t, e)
                };
    ...
    function J(t, e, n) {
        ...
        if ("string" == typeof e && (e = {
            type: e,
            target: t
        }), e = $(e), i.dispatcher && i.dispatcher.call(t, e, n), r && !e.isPropagationStopped() && !0 === e.bubbles) J.call(null, r, e, n);
    ...
    function Z(t, e, n) {
        if (Array.isArray(e)) return X(Z, t, e, n);
        var i = function r() {
            Y(t, e, r),
            n.apply(this, arguments)
        };
        i.guid = n.guid = n.guid || q(),
        G(t, e, i)
    }
    function tt(t, e) {
        e && (Ci = e),
    ...
    function nt(t, e) {
        ...
        t.state = a({},
        t.state, e),
        "function" == typeof t.handleStateChanged && xi(t) && t.on("statechanged", t.handleStateChanged),
        t
    }
    function it(t) {
    ...
    function st() {
        ...
        a++), "object" === (void 0 === s ? "undefined": Jn(s)) || u(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (t = arguments[a])) for (e in t) n = s[e],
        i = t[e],
        s !== i && (h && i && (c(i) || (r = Array.isArray(i))) ? (r ? (r = !1, o = n && Array.isArray(n) ? n: []) : o = n && c(n) ? n: {},
        s[e] = st(h, o, i)) : i !== undefined && (s[e] = i));
        return s
    }
    function at(t, e, n) {
    ...
    function ut(t, e) {
        return Array.isArray(t) ? ct(t) : t === undefined || e === undefined ? ct() : ct([[t, e]])
    }
    function ht(t, e) {
        var n = 0,
        i = void 0,
        ...
        if (!e) return 0;
        t && t.length || (t = ut(0, 0));
        for (var o = 0; o < t.length; o++) i = t.start(o),
        r = t.end(o),
        r > e && (r = e),
        n += r - i;
        return n / e
    ...
    function pt(t) {
        ...
        "number" == typeof t ? this.code = t: "string" == typeof t ? this.message = t: l(t) && ("number" == typeof t.code && (this.code = t.code), a(this, t)),
    ...
    function vt(t, e, n) {
        if (!_r(e)) throw new TypeError("iterator must be a function");
        arguments.length < 3 && (n = this),
        "[object Array]" === Er.call(t) ? mt(t, e, n) : "string" == typeof t ? _t(t, e, n) : bt(t, e, n)
    }
    function mt(t, e, n) {
        for (var i = 0,
        r = t.length; i < r; i++) wr.call(t, i) && e.call(n, t[i], i, t)
    }
    function _t(t, e, n) {
        for (var i = 0,
        r = t.length; i < r; i++) e.call(n, t.charAt(i), i, t)
    }
    function bt(t, e, n) {
        for (var i in t) wr.call(t, i) && e.call(n, t[i], i, t)
    }
    function Tt() {
        for (var t = {},
        e = 0; e < arguments.length; e++) {
            var n = arguments[e];
            for (var i in n) Pr.call(n, i) && (t[i] = n[i])
        }
        return t
    }
    function Ct(t) {
    ...
    function Et(t, e, n) {
        var i = t;
        return _r(e) ? (n = e, "string" == typeof t && (i = {
            uri: t
        })) : i = Ir(e, {
            uri: t
        }),
    ...
    function kt(t) {
        ...
        function n() {
            var t = undefined;
            if (t = a.response ? a.response: a.responseText || St(a), g) try {
                t = JSON.parse(t)
            } catch(e) {}
            return t
        }
        ...
        function r() {
            if (!c) {
                ...
                a.getAllResponseHeaders && (i.headers = Sr(a.getAllResponseHeaders()))) : r = new Error("Internal XMLHttpRequest Error"),
                s(r, i, i.body)
            }
        }
        ...
        var o = !1,
        s = function(e, n, i) {
            o || (o = !0, t.callback(e, n, i))
        },
        a = t.xhr || null;
        a || (a = t.cors || t.useXDR ? new wt.XDomainRequest: new wt.XMLHttpRequest);
        ...
        if ("json" in t && !1 !== t.json && (g = !0, f.accept || f.Accept || (f.Accept = "application/json"), "GET" !== p && "HEAD" !== p && (f["content-type"] || f["Content-Type"] || (f["Content-Type"] = "application/json"), d = JSON.stringify(!0 === t.json ? d: t.json))), a.onreadystatechange = e, a.onload = r, a.onerror = i, a.onprogress = function() {},
        a.onabort = function() {
            c = !0
        },
        a.ontimeout = i, a.open(p, h, !y, t.username, t.password), y || (a.withCredentials = !!t.withCredentials), !y && t.timeout > 0 && (u = setTimeout(function() {
            if (!c) {
                c = !0,
                a.abort("timeout");
        ...
        else if (t.headers && !Ct(t.headers)) throw new Error("Headers cannot be set on an XDomainRequest object");
    ...
    function Rt(t, e, n) {
        function i() {
            var e = xt(t);
            if (null === e) throw new Pt(Pt.Errors.BadTimeStamp, "Malformed timestamp: " + o);
        ...
        var o = t;
        if (r(), e.startTime = i(), r(), "--\x3e" !== t.substr(0, 3)) throw new Pt(Pt.Errors.BadTimeStamp, "Malformed time stamp (time stamps must be separated by '--\x3e'): " + o);
        t = t.substr(3),
        r(),
        e.endTime = i(),
        r(),
        function(t, e) {
            ...
            function(t, e) {
                switch (t) {
                case "region":
                    for (var r = n.length - 1; r >= 0; r--) if (n[r].id === e) {
                        i.set(t, n[r].region);
                        break
                    }
                    break;
                ...
                case "line":
                    ...
                    s = o[0];
                    i.integer(t, s),
                    i.percent(t, s) && i.set("snapToLines", !1),
                    i.alt(t, s, ["auto"]),
                    2 === o.length && i.alt("lineAlign", o[1], ["start", "middle", "end"]);
                    break;
                case "position":
                    o = e.split(","),
                    i.percent(t, o[0]),
                    2 === o.length && i.alt("positionAlign", o[1], ["start", "middle", "end"]);
                    break;
                case "size":
                    i.percent(t, e);
                    break;
    ...
    function At(t, e) {
        ...
        for (var i, r = t.document.createElement("div"), o = r, s = []; null !== (i = function() {
            if (!e) return null;
            var t = e.match(/^([^<]*)(<[^>]+>?)?/);
            return function(t) {
        ...
        } ());) if ("<" !== i[0]) o.appendChild(t.document.createTextNode(function(t) {
            for (; c = t.match(/&(amp|lt|gt|lrm|rlm|nbsp);/);) t = t.replace(c[0], n);
            return t
        } (i)));
        else {
            if ("/" === i[1]) {
                s.length && s[s.length - 1] === i.substr(2).replace(">", "") && (s.pop(), o = o.parentNode);
                continue
            }
            var a, l = xt(i.substr(1, i.length - 2));
            if (l) {
            ...
            if (!
            function(t, e) {
                return ! Wr[e.localName] || Wr[e.localName] === t.localName
            } (o, a)) continue;
    ...
    function jt(t) {
        ...
        for (e(r, t); o = n(r);) for (var s = 0; s < o.length; s++) if (i = o.charCodeAt(s), Ot(i)) return "rtl";
        return "ltr"
    }
    function Lt(t) {
        ...
        n = e.textTrackList,
        i = 0,
        r = 0; r < n.length && n[r] !== e; r++)"showing" === n[r].mode && i++;
        return - 1 * ++i
    }
    function Nt() {}
    function Bt(t, e, n) {
        ...
        i || (s.writingMode = "" === e.vertical ? "horizontal-tb": "lr" === e.vertical ? "vertical-lr": "vertical-rl", s.unicodeBidi = "plaintext"),
        ...
        i || (s.direction = jt(this.cueDiv), s.writingMode = "" === e.vertical ? "horizontal-tb": "lr" === e.vertical ? "vertical-lr": "vertical-rl".stylesunicodeBidi = "plaintext"),
        this.applyStyles(s),
    ...
    function Vt(t, e, n, i) {
        ...
        if (o.snapToLines) {
            ...
            var d = r.lineHeight / n.height * 100;
            switch (o.lineAlign) {
            case "middle":
                s -= d / 2;
                break;
        ...
        var f = function(t, e) {
            for (var r, o = new Ft(t), s = 1, a = 0; a < e.length; a++) {
    ...
    function qt(t) {
        return "string" == typeof t && ( !! Gr[t.toLowerCase()] && t.toLowerCase())
    }
    function zt(t) {
    ...
    function Wt(t, e, n) {
        ...
        o = {};
        r ? i = document.createElement("custom") : o.enumerable = !0,
        i.hasBeenReset = !1;
        var s = "",
        a = !1,
        l = t,
        ...
        m = 50,
        _ = "middle";
        if (Object.defineProperty(i, "id", zt({},
        o, {
            get: function() {
                return s
            },
        ...
        })), Object.defineProperty(i, "pauseOnExit", zt({},
        o, {
            get: function() {
                return a
            },
        ...
        })), Object.defineProperty(i, "startTime", zt({},
        o, {
            get: function() {
                return l
            },
        ...
        })), Object.defineProperty(i, "endTime", zt({},
        o, {
            get: function() {
                return c
            },
        ...
        })), Object.defineProperty(i, "text", zt({},
        o, {
            get: function() {
                return u
            },
        ...
        })), Object.defineProperty(i, "region", zt({},
        o, {
            get: function() {
                return h
            },
        ...
        })), Object.defineProperty(i, "vertical", zt({},
        o, {
            get: function() {
                return p
            },
        ...
        })), Object.defineProperty(i, "snapToLines", zt({},
        o, {
            get: function() {
                return d
            },
        ...
        })), Object.defineProperty(i, "line", zt({},
        o, {
            get: function() {
                return f
            },
            set: function(t) {
                if ("number" != typeof t && t !== Xr) throw new SyntaxError("An invalid number or illegal string was specified.");
                f = t,
                this.hasBeenReset = !0
            }
        })), Object.defineProperty(i, "lineAlign", zt({},
        o, {
            get: function() {
                return y
            },
        ...
        })), Object.defineProperty(i, "position", zt({},
        o, {
            get: function() {
                return g
            },
        ...
        })), Object.defineProperty(i, "positionAlign", zt({},
        o, {
            get: function() {
                return v
            },
        ...
        })), Object.defineProperty(i, "size", zt({},
        o, {
            get: function() {
                return m
            },
        ...
        })), Object.defineProperty(i, "align", zt({},
        o, {
            get: function() {
                return _
            },
        ...
        })), i.displayState = undefined, r) return i
    }
    function Kt(t) {
        return "string" == typeof t && ( !! Jr[t.toLowerCase()] && t.toLowerCase())
    }
    function Qt(t) {
    ...
    function Xt() {
        ...
        Object.defineProperties(this, {
            ...
            regionAnchorY: {
                ...
                set: function(t) {
                    if (!Qt(t)) throw new Error("RegionAnchorX must be between 0 and 100.");
                    i = t
                }
            },
            regionAnchorX: {
                ...
                set: function(t) {
                    if (!Qt(t)) throw new Error("RegionAnchorY must be between 0 and 100.");
                    n = t
                }
            },
            viewportAnchorY: {
                ...
                set: function(t) {
                    if (!Qt(t)) throw new Error("ViewportAnchorY must be between 0 and 100.");
                    o = t
                }
            },
            viewportAnchorX: {
                ...
                set: function(t) {
                    if (!Qt(t)) throw new Error("ViewportAnchorX must be between 0 and 100.");
                    r = t
                }
            },
            scroll: {
    ...
    function Zt(t, e, n) {
        return t.reduceRight(ee(n), e[n]())
    }
    function te(t, e, n, i) {
        return e[n](t.reduce(ee(n), i))
    }
    function ee(t) {
        return function(e, n) {
            return n[t] ? n[t](e) : e
    ...
    function ne() {
        ...
        s = e[0],
        l = e.slice(1);
        if ("string" == typeof s) ne(t, no[s], n, i, r, o);
        else if (s) {
            var c = s(i);
            c.setSource(a({},
            t),
            function(e, s) {
                if (e) return ne(t, l, n, i, r, o);
                r.push(c),
                ne(s, t.type === s.type ? l: no[s.type], n, i, r, o)
            })
        } else l.length ? ne(t, l, n, i, r, o) : o ? n(t, r) : ne(t, no["*"], n, i, r, !0)
    }
    function ie(t, e) {
    ...
    function oe(t) {
        ...
        s = Math.floor(e / 3600);
        return (isNaN(t) || t === Infinity) && (r = i = n = "-"),
        r = r > 0 || s > 0 ? r + ":": "",
        i = ((r || o >= 10) && i < 10 ? "0" + i: i) + ":",
        n = n < 10 ? "0" + n: n,
        r + i + n
    ...
    function ae(t, e) {
        return se(t.options[t.options.selectedIndex].value, e)
    }
    function le(t, e, n) {
        if (e) for (var i = 0; i < t.options.length; i++) if (se(t.options[i].value, n) === e) {
            t.selectedIndex = i;
            break
        }
    }
    function ce(t, e, n) {
        ...
        if ("string" == typeof t) {
            var r = ce.getPlayers();
            if (0 === t.indexOf("#") && (t = t.slice(1)), r[t]) return e && ci.warn('Player "' + t + '" is already initialised. Options will not be applied.'),
            n && r[t].ready(n),
            r[t];
            i = pi("#" + t)
        } else i = t;
        if (!i || !i.nodeName) throw new TypeError("The element or ID supplied is not valid. (videojs)");
        if (i.player || Ps.players[i.playerId]) return i.player || Ps.players[i.playerId];
        v(i) && !sn.body.contains(i) && ci.warn("The element supplied is not included in the DOM"),
        e = e || {},
        ce.hooks("beforesetup").forEach(function(t) {
            var n = t(i, ot(e));
            if (!l(n) || Array.isArray(n)) return void ci.error("please return an object in beforesetup hooks");
            e = ot(e, n)
        });
        var o = Bi.getComponent("Player"),
        s = new o(i, e, n);
        return ce.hooks("setup").forEach(function(t) {
            return t(s)
        }),
        s
    }
    ...
    function he(t, e) {
        ...
        var n = t.slice(0, e),
        i = t.slice(e);
        return Array.prototype.concat.call([], he(n), he(i))
    }
    function pe(t) {
        try {
            return decodeURIComponent(t)
        } catch(i) {
            for (var e = t.match($s), n = 1; n < e.length; n++) t = he(e, n).join(""),
            e = t.match($s);
            return t
        }
    }
    ...
    function fe(t) {
        ...
        case "index":
            return function(e, n, i) {
                return null === n ? [ge(e, t), "[", i, "]"].join("") : [ge(e, t), "[", ge(i, t), "]=", ge(n, t)].join("")
            };
        case "bracket":
            return function(e, n) {
                return null === n ? ge(e, t) : [ge(e, t), "[]=", ge(n, t)].join("")
            };
        default:
            return function(e, n) {
                return null === n ? ge(e, t) : [ge(e, t), "=", ge(n, t)].join("")
    ...
    function ye(t) {
        ...
        case "bracket":
            return function(t, n, i) {
                return e = /(\[\])$/.exec(t),
                t = t.replace(/\[\]$/, ""),
                e ? i[t] === undefined ? void(i[t] = [n]) : void(i[t] = [].concat(i[t], n)) : void(i[t] = n)
            };
        default:
    ...
    function ge(t, e) {
        return e.encode ? e.strict ? zs(t) : encodeURIComponent(t) : t
    }
    function ve(t) {
        return Array.isArray(t) ? t.sort() : "object" == typeof t ? ve(Object.keys(t)).sort(function(t, e) {
    ...
    function _e(t, e) {
        ...
        return "string" != typeof t ? i: (t = t.trim().replace(/^[?#&]/, "")) ? (t.split("&").forEach(function(t) {
            ...
            o = o === undefined ? null: Ys(o),
            n(Ys(r), o, i)
        }), Object.keys(i).sort().reduce(function(t, e) {
            var n = i[e];
            return Boolean(n) && "object" == typeof n && !Array.isArray(n) ? t[e] = ve(n) : t[e] = n,
            t
        },
    ...
    function be(t, e, n) {
        ...
        o = "object" == Jn(e.param) ? na.stringify(e.param) : e.param;
        ...
        c.onreadystatechange = function() {
            "loaded" === this.readyState && window[a] && (i(), n && n(new Error("ServerError")))
        },
    ...
    function Se(t, e, n) {
        ...
        if (r.onload = r.onreadystatechange = function() {
            this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState || ("function" == typeof e && e(), r.onload = r.onreadystatechange = null, r.parentNode && !i && r.parentNode.removeChild(r))
        },
    ...
    function Ie(t) {
        ...
        return function i(t, r) {
            ...
            s = void 0,
            a = void 0;
            if (t) if (Array.isArray(r)) for (o = 0, s = r.length; o < s; o++) i(t + "[" + ("object" === Jn(r[o]) && r[o] ? o: "") + "]", r[o]);
            else if ("[object Object]" === String(r)) for (a in r) i(t + "[" + a + "]", r[a]);
            else n(t, r);
            else if (Array.isArray(r)) for (o = 0, s = r.length; o < s; o++) n(r[o].name, r[o].value);
            else for (a in r) i(a, r[a]);
            return e
        } ("", t).join("&")
    }
    function Pe(t) {
    ...
    function Me(e) {
        if (ce.browser.IS_IOS && ce.browser.IS_MQQ) return ! 1;
        if (t && t.isSupported() && !ce.browser.IS_TBS && !ce.browser.IS_MQQB && !ce.browser.IS_SAFARI || e) try {
            var n = ce.getTech && ce.getTech("Html5");
            n && n.registerSourceHandler(Ca, 0)
        } catch(i) {}
    }
    function Re(t, n) {
        function i(t) {
        ...
        t.dash.mediaPlayer.on(e.MediaPlayer.events.STREAM_TEARDOWN_COMPLETE,
        function() {
            a.removeEventListener("change", c)
        })
    }
    function Ae(t, n) {
        t.dash.mediaPlayer.on(e.MediaPlayer.events.PLAYBACK_METADATA_LOADED, Re.bind(null, t, n))
    }
    function Oe(t, e) {
    ...
    function je(t, n, i) {
        function r() {
            for (var e = t.dash.mediaPlayer,
            n = t.textTracks(), r = -1, s = 0; s < n.length; s += 1) !
            function(t) {
                var e = n[t];
                if ("showing" === e.mode) {
                    var s = Oe(o,
        ...
        return t.textTracks().on("change", r),
        t.dash.mediaPlayer.on(e.MediaPlayer.events.STREAM_TEARDOWN_COMPLETE,
        function() {
    ...
    function Le(t, n, i) {
        ...
        function o(l) {
            ...
            r(),
            c.length && (s = je(t, n, c, i))
        }
        tn.VTTCue && !/\[native code\]/.test(tn.VTTCue.toString()) && (tn.VTTCue = !1);
        var s = [];
        if (n.featuresNativeTextTracks) return void ce.log.error("You must pass {html: {nativeCaptions: false}} in the videojs constructor to use text tracks in videojs-contrib-dash");
        var a = t.dash.mediaPlayer;
        a.on(e.MediaPlayer.events.TEXT_TRACKS_ADDED, o),
        a.on(e.MediaPlayer.events.CAN_PLAY,
        function() {
            a.off(e.MediaPlayer.events.TEXT_TRACKS_ADDED, o)
        })
    }
    function Ne(t) { (tn.MediaSource && e || t) && ce.getTech("Html5").registerSourceHandler(ce.DashSourceHandler(), 0)
    }
    function Be() {
    ...
    function Ue(t) {
        return null == t ? t === undefined ? kl: wl: Sl && Sl in Object(t) ? bl(t) : El(t)
    }
    function qe(t) {
        return null != t && "object" == typeof t
    }
    function ze(t) {
        return "symbol" == typeof t || Pl(t) && Il(t) == xl
    }
    function We(t) {
        ...
        t = t.replace(Rl, "");
        var n = Ol.test(t);
        return n || jl.test(t) ? Ll(t.slice(2), n ? 2 : 8) : Al.test(t) ? Ml: +t
    }
    function Ke(t, e, n) {
        function i(e) {
            var n = p,
        ...
        function s(t) {
            var n = t - v,
            i = t - m;
            return v === undefined || n >= e || n < 0 || b && i >= f
        }
        function a() {
            var t = dl();
            if (s(t)) return l(t);
        ...
        b = !1,
        T = !0;
        if ("function" != typeof t) throw new TypeError(Bl);
        return e = Nl(e) || 0,
        sl(n) && (_ = !!n.leading, b = "maxWait" in n, f = b ? Fl(Nl(n.maxWait) || 0, e) : f, T = "trailing" in n ? !!n.trailing: T),
        h.cancel = c,
        h.flush = u,
        h
    }
    function Qe(t, e, n) {
        var i = !0,
        r = !0;
        if ("function" != typeof t) throw new TypeError(Ul);
        return sl(n) && (i = "leading" in n ? !!n.leading: i, r = "trailing" in n ? !!n.trailing: r),
        Hl(t, e, {
            leading: i,
            maxWait: e,
            trailing: r
    ...
    function Xe(t) {
        if (ce.browser.IS_IOS && ce.browser.IS_MQQ) return ! 1;
        if (n && n.isSupported() && !ce.browser.IS_TBS && !ce.browser.IS_MQQB && !ce.browser.IS_SAFARI && !ce.browser.IE_VERSION || t) try {
            var e = ce.getTech && ce.getTech("Html5");
            e && e.registerSourceHandler(yh, 0)
        } catch(i) {}
    }
    function $e(t) {
        kh[t] = function() {
    ...
    function Ge(t, e, n) {
        ...
        r = (new Date).getTime(),
        o = ce.dom;
        if ("string" == typeof t) i = document.querySelector("#" + t);
        else {
            if (!t || !t.nodeName) throw new TypeError("The ID or element supplied is not valid.");
            i = t
        }
        if ("video" != i.nodeName.toLowerCase() && "audio" != i.nodeName.toLowerCase()) throw new TypeError("The element type must be <video>.");
        o.hasClass(i, "tcplayer") || o.addClass(i, "tcplayer"),
        o.hasClass(i, "video-js") || o.addClass(i, "video-js"),
        ce.browser.IE_VERSION && (i.style.width || i.offsetWidth && 300 !== i.offsetWidth) && (tn.VIDEOJS_NO_DYNAMIC_STYLE = !0);
        var s = {
            controls: !0,
            language: "zh-CN",
            ...
            controlBar: {
                volumePanel: {
                    inline: "video" != i.nodeName.toLowerCase()
                },
                fullscreenToggle: "video" == i.nodeName.toLowerCase(),
        ...
        e = ce.mergeOptions(s, e),
        ce.browser.IE_VERSION && ce.browser.IE_VERSION < 11 && tn.top,
        e.autoplay && ce.browser.IS_ANDROID && ce.browser.IS_WECHAT && (e.autoplay = !1),
        Mh("player initializing", e),
        ce.getComponent("player").prototype.options_.children.splice(1, 0, "logoImage");
        var a = ce(t, e, n);
        return a.PlayerMetrics().setTimingData({
            initStart: r
        }),
        Mh("player initialized", e),
        a
    }
    t = t && t.hasOwnProperty("default") ? t["default"] : t,
    e = e && e.hasOwnProperty("default") ? e["default"] : e,
    n = n && n.hasOwnProperty("default") ? n["default"] : n;
    var Ye, Je = "undefined" != typeof window ? window: "undefined" != typeof global ? global: "undefined" != typeof self ? self: {};
    Ye = "undefined" != typeof window ? window: void 0 !== Je ? Je: "undefined" != typeof self ? self: {};
    var Ze, tn = Ye,
    en = {},
    ...
    rn = nn && en || nn,
    on = void 0 !== Je ? Je: "undefined" != typeof window ? window: {};
    "undefined" != typeof document ? Ze = document: (Ze = on["__GLOBAL_DOCUMENT_CACHE@4"]) || (Ze = on["__GLOBAL_DOCUMENT_CACHE@4"] = rn);
    var sn = Ze,
    an = tn.navigator && tn.navigator.userAgent || "",
    ln = /AppleWebKit\/([\d.]+)/i.exec(an),
    cn = ln ? parseFloat(ln.pop()) : null,
    un = /iPad/i.test(an),
    hn = /iPhone/i.test(an) && !un,
    pn = /iPod/i.test(an),
    dn = hn || un || pn,
    fn = function() {
        var t = an.match(/OS (\d+)_/i);
        return t && t[1] ? t[1] : null
    } (),
    yn = /Android/i.test(an),
    gn = function() {
        var t = an.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i);
        if (!t) return null;
    ...
    vn = /TBS\/\d+/i.test(an),
    mn = function() {
        var t = an.match(/TBS\/(\d+)/i);
        if (t && t[1]) return t[1]
    } (),
    _n = !vn && /MQQBrowser\/\d+/i.test(an),
    bn = !vn && / QQBrowser\/\d+/i.test(an),
    Tn = /(micromessenger|webbrowser)/i.test(an),
    Cn = / QQ\/\d+/i.test(an),
    En = yn && /webkit/i.test(an) && gn < 2.3,
    wn = yn && gn < 5 && cn < 537,
    kn = /Firefox/i.test(an),
    Sn = /Edge/i.test(an),
    In = function() {
        return ! (Sn || !/Chrome/i.test(an)) || !(!/Safari/i.test(an) || !/CriOS/i.test(an))
    } () && !Tn && !_n && !bn,
    Pn = function() {
        var t = an.match(/Chrome\/(\d+)/),
        e = an.match(/CriOS\/(\d+)/);
        return t && t[1] ? parseFloat(t[1]) : e && e[1] ? parseFloat(e[1]) : null
    } (),
    xn = /MSIE\s8\.0/.test(an),
    Dn = function() {
        var t = /MSIE\s(\d+)\.\d/.exec(an),
        e = t && parseFloat(t[1]);
        return ! e && /Trident\/7.0/i.test(an) && /rv:11.0/.test(an) && (e = 11),
        e
    } (),
    Mn = /Safari/i.test(an) && !In && !yn && !Sn && !_n && !bn,
    Rn = Mn || dn,
    An = g() && ("ontouchstart" in tn || tn.DocumentTouch && tn.document instanceof tn.DocumentTouch),
    On = g() && "backgroundSize" in tn.document.createElement("video").style,
    jn = /Windows/i.test(an),
    Ln = /MAC OS X/i.test(an),
    Nn = function() {
        return /Windows NT ([.\w]+)/.test(an),
        "win" + RegExp.$1
    } (),
    Bn = function() {
        return /Mac OS X (\w+)/.test(an),
        "mac" + RegExp.$1
    } (),
    Fn = function() {
        return /QQBrowser\/([.\d]+)/.test(an),
        "qq" + RegExp.$1
    } (),
    Vn = function() {
        return /Edge\/([.\d]+)/.test(an),
        "edge" + RegExp.$1
    } (),
    Hn = function() {
        return /Version\/([.\d]+)/.test(an),
        "safari" + RegExp.$1
    } (),
    Un = function() {
        return /Firefox\/([.\d]+)/.test(an),
        "firefox" + RegExp.$1
    } (),
    qn = /HUAWEI|honor|HMA/i.test(an),
    zn = /HM|RedMi|Mi/i.test(an) && !qn,
    Wn = /OPPO/i.test(an),
    Kn = /VIVO/i.test(an),
    Qn = /GT-|SM-|SCH-/i.test(an),
    Xn = /ONE/i.test(an),
    $n = /Coolpad/i.test(an),
    Gn = /ZTE/i.test(an),
    ...
    Jn = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
    function(t) {
        return typeof t
    }: function(t) {
    ...
    ai = [],
    li = function(t, e) {
        var n = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : !!Dn && Dn < 11,
        i = oi.levels[si],
        r = new RegExp("^(" + i + ")$");
        if ("log" !== t && e.unshift(t.toUpperCase() + ":"), ai && ai.push([].concat(e)), (oi.enableLog || "log" != t) && (e.unshift("TCPlayer:"), tn.console)) {
            var o = tn.console[t];
            o || "debug" !== t || (o = tn.console.info || tn.console.log),
            o && i && r.test(t) && (n && (e = e.map(function(t) {
                if (l(t) || Array.isArray(t)) try {
                    return JSON.stringify(t)
                } catch(e) {
                    return String(t)
                }
                return String(t)
            }).join(" ")), o.apply ? o[Array.isArray(e) ? "apply": "call"](tn.console, e) : o(e))
        }
    };
    oi = function() {
    ...
    oi.level = function(t) {
        if ("string" == typeof t) {
            if (!oi.levels.hasOwnProperty(t)) throw new Error('"' + t + '" in not a valid log level');
            si = t
        }
        return si
    },
    ...
    oi.history.clear = function() {
        ai && (ai.length = 0)
    },
    oi.history.disable = function() {
        null !== ai && (ai.length = 0, ai = null)
    },
    oi.history.enable = function() {
        null === ai && (ai = [])
    },
    oi.enableLog = !1,
    oi.error = function() {
    ...
    ui = function(t) {
        for (var e = "",
        n = 0; n < arguments.length; n++) e += h(t[n]) + (arguments[n + 1] || "");
        return e
    },
    hi = ni(["Setting attributes in the second argument of createEl()\n                has been deprecated. Use the third argument instead.\n                createEl(type, properties, attributes). Attempting to set ", " to ", "."], ["Setting attributes in the second argument of createEl()\n                has been deprecated. Use the third argument instead.\n                createEl(type, properties, attributes). Attempting to set ", " to ", "."]),
    pi = _("querySelector"),
    di = _("querySelectorAll"),
    ...
    function() {
        try {
            ...
            tn.addEventListener("test", null, t),
            tn.removeEventListener("test", null, t)
        } catch(e) {}
    } ();
    var _i = ["touchstart", "touchmove"],
    ...
    Ei = function() {
        if (g()) {
            var t = sn.getElementsByTagName("video"),
            e = sn.getElementsByTagName("audio"),
            n = sn.getElementsByTagName("video-js"),
            i = [];
            if (t && t.length > 0) for (var r = 0,
            o = t.length; r < o; r++) i.push(t[r]);
            if (e && e.length > 0) for (var s = 0,
            a = e.length; s < a; s++) i.push(e[s]);
            if (n && n.length > 0) for (var l = 0,
            c = n.length; l < c; l++) i.push(n[l]);
            if (i && i.length > 0) for (var u = 0,
            h = i.length; u < h; u++) {
                var p = i[u];
                if (!p || !p.getAttribute) {
                    tt(1);
    ...
    g() && "complete" === sn.readyState ? Ti = !0 : Z(tn, "load",
    function() {
        Ti = !0
    });
    var wi = function(t) {
        var e = sn.createElement("style");
    ...
    Si = function(t, e, n) {
        ...
        return i.guid = n ? n + "_" + e.guid: e.guid,
        i
    },
    Ii = function(t, e) {
        var n = Date.now();
        return function() {
            var i = Date.now();
            i - n >= e && (t.apply(undefined, arguments), n = i)
        }
    },
    Pi = function() {};
    Pi.prototype.allowedEvents_ = {},
    Pi.prototype.on = function(t, e) {
        var n = this.addEventListener;
        this.addEventListener = function() {},
        G(this, t, e),
        this.addEventListener = n
    },
    Pi.prototype.addEventListener = Pi.prototype.on,
    Pi.prototype.off = function(t, e) {
        Y(this, t, e)
    },
    Pi.prototype.removeEventListener = Pi.prototype.off,
    Pi.prototype.one = function(t, e) {
        var n = this.addEventListener;
        this.addEventListener = function() {},
        Z(this, t, e),
        this.addEventListener = n
    },
    Pi.prototype.trigger = function(t) {
        var e = t.type || t;
        "string" == typeof t && (t = {
            type: e
        }),
    ...
    Pi.prototype.dispatchEvent = Pi.prototype.trigger;
    var xi = function(t) {
        return t instanceof Pi || !!t.eventBusEl_ && ["on", "one", "off", "trigger"].every(function(e) {
    ...
    Mi = function(t) {
        if (!t.nodeName && !xi(t)) throw new Error("Invalid target; must be a DOM node or evented object.")
    },
    Ri = function(t) {
    ...
    Oi = function(t, e) {
        ...
        r = void 0,
        o = void 0;
        return n ? (i = t.eventBusEl_, e.length >= 3 && e.shift(), r = e[0], o = e[1]) : (i = e[0], r = e[1], o = e[2]),
        Mi(i),
        Ri(r),
        Ai(o),
        o = Si(t, o),
    ...
    Li = {
        ...
        off: function(t, e, n) {
            if (!t || Di(t)) Di(e) ? Y(this.eventBusEl_, e, n) : Y(this.eventBusEl_, t, e);
            else {
                var i = t,
                r = e;
                Mi(i),
                ...
                n = Si(this, n),
                this.off("dispose", n),
                i.nodeName ? (Y(i, r, n), Y(i, "dispose", n)) : xi(i) && (i.off(r, n), i.off("dispose", n))
            }
        },
    ...
    Bi = function() {
        function t(e, n, i) {
            if (Zn(this, t), !e && this.play ? this.player_ = e = this: this.player_ = e, this.options_ = st(!0, {},
            this.options_), n = this.options_ = ot(this.options_, n), this.id_ = n.id || n.el && n.el.id, !this.id_) {
            ...
            nt(this, this.constructor.defaultState),
            this.children_ = [],
            this.childIndex_ = {},
        ...
        return t.prototype.dispose = function() {
            ...
            this.el_ && (this.el_.parentNode && this.el_.parentNode.removeChild(this.el_), K(this.el_), this.el_ = null),
            this.player_ = null
        },
        ...
        t.prototype.options = function(t) {
            return ci.warn("this.options() has been deprecated and will be moved to the constructor in 6.0"),
            t ? (this.options_ = ot(this.options_, t), this.options_) : this.options_
        },
        ...
        t.prototype.addChild = function(e) {
            ...
            i = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.children_.length,
            r = void 0,
            o = void 0;
            if ("string" == typeof e) {
                o = it(e);
            ...
            if (this.children_.splice(i, 0, r), "function" == typeof r.id && (this.childIndex_[r.id()] = r), o = o || r.name && it(r.name()), o && (this.childNameIndex_[o] = r), "function" == typeof r.el && r.el()) {
        ...
        t.prototype.initChildren = function() {
            ...
            if (n) {
                ...
                r = function(t) {
                    var n = t.name,
                    r = t.opts;
                    if (i[n] !== undefined && (r = i[n]), !1 !== r) { ! 0 === r && (r = {}),
                ...
                o.concat(Object.keys(this.options_).filter(function(t) {
                    ...
                    var i = void 0,
                    r = void 0;
                    return "string" == typeof t ? (i = t, r = n[i] || e.options_[i] || {}) : (i = t.name, r = t),
                    {
                        name: i,
                        opts: r
                    }
                }).filter(function(e) {
                    var n = t.getComponent(e.opts.componentClass || it(e.name));
                    return n && !s.isTech(n)
                }).forEach(r)
            }
        },
        ...
        t.prototype.$ = function(t, e) {
            return pi(t, e || this.contentEl())
        },
        t.prototype.$$ = function(t, e) {
            return di(t, e || this.contentEl())
        },
        ...
        t.prototype.dimension = function(t, e, n) {
            ...
            r = i.indexOf("px");
            return - 1 !== r ? parseInt(i.slice(0, r), 10) : parseInt(this.el_["offset" + it(t)], 10)
        },
        t.prototype.currentDimension = function(t) {
            var e = 0;
            if ("width" !== t && "height" !== t) throw new Error("currentDimension only accepts width or height value");
            if ("function" == typeof tn.getComputedStyle) {
                var n = tn.getComputedStyle(this.el_);
        ...
        t.prototype.emitTapEvents = function() {
            ...
            function(t) {
                if (t.touches.length > 1) n = !1;
                    ...
                    var i = t.touches[0].pageX - e.pageX,
            ...
            this.on("touchend",
            function(i) {
                if (e = null, !0 === n) { (new Date).getTime() - t < 200 && (i.preventDefault(), this.trigger("tap"))
                }
            })
        },
        t.prototype.enableTouchActivity = function() {
            if (this.player() && this.player().reportUserActivity) {
                var t = Si(this.player(), this.player().reportUserActivity),
                e = void 0;
                this.on("touchstart",
                function() {
                    t(),
        ...
        t.prototype.requestAnimationFrame = function(t) {
            ...
            if (this.supportsRaf_) {
                t = Si(this, t);
                var n = tn.requestAnimationFrame(t),
                i = function() {
    ...
    Bi.prototype.supportsRaf_ = "function" == typeof tn.requestAnimationFrame && "function" == typeof tn.cancelAnimationFrame,
    Bi.registerComponent("Component", Bi);
    for (var Fi = {},
    Vi = [["requestFullscreen", "exitFullscreen", "fullscreenElement", "fullscreenEnabled", "fullscreenchange", "fullscreenerror"], ["webkitRequestFullscreen", "webkitExitFullscreen", "webkitFullscreenElement", "webkitFullscreenEnabled", "webkitfullscreenchange", "webkitfullscreenerror"], ["webkitRequestFullScreen", "webkitCancelFullScreen", "webkitCurrentFullScreenElement", "webkitCancelFullScreen", "webkitfullscreenchange", "webkitfullscreenerror"], ["mozRequestFullScreen", "mozCancelFullScreen", "mozFullScreenElement", "mozFullScreenEnabled", "mozfullscreenchange", "mozfullscreenerror"], ["msRequestFullscreen", "msExitFullscreen", "msFullscreenElement", "msFullscreenEnabled", "MSFullscreenChange", "MSFullscreenError"]], Hi = Vi[0], Ui = void 0, qi = !1, zi = 0; zi < Vi.length; zi++) if (Vi[zi][1] in sn) {
        Ui = Vi[zi];
        break
    }
    if (Ui) {
        for (var Wi = 0; Wi < Ui.length; Wi++) Fi[Hi[Wi]] = Ui[Wi];
        qi = Ui[0] === Hi[0]
    }
    pt.prototype.code = 0,
    ...
    for (var Ki = 0; Ki < pt.errorTypes.length; Ki++) pt[pt.errorTypes[Ki]] = Ki,
    pt.prototype[pt.errorTypes[Ki]] = Ki;
    var Qi = dt,
    Xi = function(t) {
    ...
    Zi = function(t) {
        function e(n, i) {
            ...
            r.descEl_ = b("p", {
                className: Ji + "-description vjs-control-text",
        ...
        e.prototype.buildCSSClass = function() {
            return Ji + " vjs-hidden " + t.prototype.buildCSSClass.call(this)
        },
        ...
        e.prototype.open = function() {
            if (!this.opened_) {
                ...
                this.closeable() && this.on(this.el_.ownerDocument, "keydown", Si(this, this.handleKeyPress)),
        ...
        e.prototype.close = function() {
            if (this.opened_) {
                ...
                this.closeable() && this.off(this.el_.ownerDocument, "keydown", Si(this, this.handleKeyPress)),
        ...
        e.prototype.conditionalFocus_ = function() {
            ...
            e = this.player_.el_;
            this.previouslyActiveEl_ = null,
            (e.contains(t) || e === t) && (this.previouslyActiveEl_ = t, this.focus(), this.on(sn, "keydown", this.handleKeyDown))
        },
        e.prototype.conditionalBlur_ = function() {
            this.previouslyActiveEl_ && (this.previouslyActiveEl_.focus(), this.previouslyActiveEl_ = null),
            this.off(sn, "keydown", this.handleKeyDown)
        },
        ...
        e.prototype.focusableEls_ = function() {
            ...
            function(t) {
                return (t instanceof tn.HTMLAnchorElement || t instanceof tn.HTMLAreaElement) && t.hasAttribute("href") || (t instanceof tn.HTMLInputElement || t instanceof tn.HTMLSelectElement || t instanceof tn.HTMLTextAreaElement || t instanceof tn.HTMLButtonElement) && !t.hasAttribute("disabled") || t instanceof tn.HTMLIFrameElement || t instanceof tn.HTMLObjectElement || t instanceof tn.HTMLEmbedElement || t.hasAttribute("tabindex") && -1 !== t.getAttribute("tabindex") || t.hasAttribute("contenteditable")
            })
        },
        e
    } (Bi);
    ...
    Bi.registerComponent("ModalDialog", Zi);
    var tr = function(t) {
        function e() {
            var n, i = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [],
            r = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
            Zn(this, e);
            var o = ei(this, t.call(this));
            if (!r && (r = o, xn)) {
                r = sn.createElement("custom");
        ...
        e.prototype.removeTrack = function(t) {
            for (var e = void 0,
            n = 0,
            i = this.length; n < i; n++) if (this[n] === t) {
                e = this[n],
                e.off && e.off(),
    ...
    for (var er in tr.prototype.allowedEvents_) tr.prototype["on" + er] = null;
    var nr = function(t, e) {
        for (var n = 0; n < t.length; n++) Object.keys(t[n]).length && e.id !== t[n].id && (t[n].enabled = !1)
    },
    ir = function(t) {
        function e() {
            var n, i, r = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
            Zn(this, e);
            for (var o = void 0,
            s = r.length - 1; s >= 0; s--) if (r[s].enabled) {
                nr(r, r[s]);
                break
            }
            if (xn) {
                o = sn.createElement("custom");
                for (var a in tr.prototype)"constructor" !== a && (o[a] = tr.prototype[a]);
                for (var l in e.prototype)"constructor" !== l && (o[l] = e.prototype[l])
            }
            return o = n = ei(this, t.call(this, r, o)),
            o.changing_ = !1,
            i = o,
            ei(n, i)
        }
        ...
        e.prototype.addTrack = function(e) {
            ...
            function() {
                n.changing_ || (n.changing_ = !0, nr(n, e), n.changing_ = !1, n.trigger("change"))
            })
        },
        e
    } (tr),
    ...
    or = function(t) {
        function e() {
            ...
            Zn(this, e);
            for (var o = void 0,
            s = r.length - 1; s >= 0; s--) if (r[s].selected) {
                rr(r, r[s]);
                break
            }
            if (xn) {
        ...
        e.prototype.addTrack = function(e) {
            var n = this;
            e.selected && rr(this, e),
            t.prototype.addTrack.call(this, e),
            e.addEventListener && e.addEventListener("selectedchange",
            function() {
                n.changing_ || (n.changing_ = !0, rr(n, e), n.changing_ = !1, n.trigger("change"))
            })
        },
        e
    } (tr),
    sr = function(t) {
        function e() {
            ...
            if (xn) {
                o = sn.createElement("custom");
                for (var s in tr.prototype)"constructor" !== s && (o[s] = tr.prototype[s]);
        ...
        e.prototype.addTrack = function(e) {
            ...
            t.prototype.addTrack.call(this, e),
            e.addEventListener("modechange", Si(this,
            function() {
                this.trigger("change")
            })),
            -1 === ["metadata", "chapters"].indexOf(e.kind) && e.addEventListener("modechange", Si(this,
            function() {
    ...
    ar = function() {
        function t() {
            ...
            for (var r = 0,
            o = e.length; r < o; r++) n.addTrackElement_(e[r]);
            if (xn) return n
        }
        ...
        t.prototype.getTrackElementByTrack_ = function(t) {
            for (var e = void 0,
            n = 0,
            i = this.trackElements_.length; n < i; n++) if (t === this.trackElements_[n].track) {
    ...
    fr = function(t) {
        ...
        n = sn.createElement("a");
        n.href = t;
        var i = "" === n.host && "file:" !== n.protocol,
        r = void 0;
        i && (r = sn.createElement("div"), r.innerHTML = '<a href="' + t + '"></a>', n = r.firstChild, r.setAttribute("style", "display:none; position:absolute;"), sn.body.appendChild(r));
        for (var o = {},
        s = 0; s < e.length; s++) o[e[s]] = n[e[s]];
        return "http:" === o.protocol && (o.host = o.host.replace(/:80$/, "")),
        "https:" === o.protocol && (o.host = o.host.replace(/:443$/, "")),
        o.protocol || (o.protocol = tn.location.protocol),
        i && sn.body.removeChild(r),
        o
    },
    yr = function(t) {
        if (!t.match(/^https?:\/\//)) {
    ...
    Sr = function(t) {
        if (!t) return {};
        var e = {};
        return Cr(Tr(t).split("\n"),
        function(t) {
            var n = t.indexOf(":"),
            i = Tr(t.slice(0, n)).toLowerCase(),
            r = Tr(t.slice(n + 1));
            "undefined" == typeof e[i] ? e[i] = r: kr(e[i]) ? e[i].push(r) : e[i] = [e[i], r]
        }),
        e
    },
    Ir = Tt,
    ...
    xr = wt;
    wt.XMLHttpRequest = tn.XMLHttpRequest || It,
    wt.XDomainRequest = "withCredentials" in new wt.XMLHttpRequest ? wt.XMLHttpRequest: tn.XDomainRequest,
    function(t, e) {
        for (var n = 0; n < t.length; n++) e(t[n])
    } (["get", "put", "post", "patch", "head", "delete"],
    function(t) {
        wt["delete" === t ? "del": t] = function(e, n, i) {
            return n = Et(e, n, i),
    ...
    var Dr = function(t, e) {
        var n = new tn.WebVTT.Parser(tn, tn.vttjs, tn.WebVTT.StringDecoder()),
        i = [];
        n.oncue = function(t) {
            e.addCue(t)
        },
        ...
        n.parse(t),
        i.length > 0 && (tn.console && tn.console.groupCollapsed && tn.console.groupCollapsed("Text Track parsing errors for " + e.src), i.forEach(function(t) {
            return ci.error(t)
        }), tn.console && tn.console.groupEnd && tn.console.groupEnd()),
        n.flush()
    },
    Mr = function(t, e) {
        var n = {
        ...
        xr(n, Si(this,
        function(t, n, i) {
            if (t) return ci.error(t, n);
            if (e.loaded_ = !0, "function" != typeof tn.WebVTT) {
                if (e.tech_) {
                    var r = function() {
                        return Dr(i, e)
                    };
                    ...
                    function() {
                        ci.error("vttjs failed to load, stopping trying to process " + e.src),
    ...
    Rr = function(t) {
        function e() {
            var n, i, r = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
            if (Zn(this, e), !r.tech) throw new Error("A tech was not provided.");
            var o = ot(r, {
                kind: hr[r.kind] || "subtitles",
                language: r.language || r.srclang || ""
            }),
            s = pr[o.mode] || "disabled",
            a = o["default"];
            "metadata" !== o.kind && "chapters" !== o.kind || (s = "hidden");
            var l = n = ei(this, t.call(this, o));
            if (l.tech_ = o.tech, xn) for (var c in e.prototype)"constructor" !== c && (l[c] = e.prototype[c]);
            l.cues_ = [],
            l.activeCues_ = [];
            var u = new lr(l.cues_),
            h = new lr(l.activeCues_),
            p = !1,
            d = Si(l,
            function() {
                this.activeCues,
            ...
            Object.defineProperty(l, "mode", {
                ...
                set: function(t) {
                    var e = this;
                    pr[t] && (s = t, "showing" === s && this.tech_.ready(function() {
            ...
            o.src ? (l.src = o.src, Mr(o.src, l)) : l.loaded_ = !0,
            i = l,
            ei(n, i)
        }
        return ti(e, t),
        e.prototype.addCue = function(t) {
            var e = t;
            if (tn.vttjs && !(t instanceof tn.vttjs.VTTCue)) {
                e = new tn.vttjs.VTTCue(t.startTime, t.endTime, t.text);
    ...
    var Ar = function(t) {
        function e() {
            ...
            s = n = ei(this, t.call(this, o)),
            a = !1;
            if (xn) for (var l in e.prototype)"constructor" !== l && (s[l] = e.prototype[l]);
    ...
    Nr = function(t) {
        function e() {
            ...
            }), r = jr, a.addEventListener("loadeddata",
            function() {
                r = Lr,
                o.trigger({
                    type: "load",
    ...
    Vr = ot(Br, Fr);
    Fr.names = Object.keys(Fr),
    Br.names = Object.keys(Br),
    Vr.names = [].concat(Fr.names).concat(Br.names);
    ...
    Pt.prototype = Hr(Error.prototype),
    ...
    Nt.prototype.applyStyles = function(t, e) {
        e = e || this.div;
        for (var n in t) t.hasOwnProperty(n) && (e.style[n] = t[n])
    },
    Nt.prototype.formatStyle = function(t, e) {
        return 0 === t ? 0 : t + e
    },
    Bt.prototype = Hr(Nt.prototype),
    Bt.prototype.constructor = Bt,
    Ft.prototype.move = function(t, e) {
    ...
    Ft.prototype.overlaps = function(t) {
        return this.left < t.right && this.right > t.left && this.top < t.bottom && this.bottom > t.top
    },
    Ft.prototype.overlapsAny = function(t) {
        for (var e = 0; e < t.length; e++) if (this.overlaps(t[e])) return ! 0;
        return ! 1
    },
    Ft.prototype.within = function(t) {
        return this.top >= t.top && this.bottom <= t.bottom && this.left >= t.left && this.right <= t.right
    },
    Ft.prototype.overlapsOppositeAxis = function(t, e) {
        switch (e) {
        case "+x":
    ...
    Ft.prototype.intersectPercentage = function(t) {
    ...
    Ft.prototype.toCSSCompatValues = function(t) {
        return {
            top: this.top - t.top,
    ...
    Ft.getSimpleBoxPosition = function(t) {
    ...
    Ht.convertCueToDOMTree = function(t, e) {
        return t && e ? At(t, e) : null
    };
    Ht.processCues = function(t, e, n) {
        ...
        function(t) {
            ...
            function() {
                ...
                r.push(Ft.getSimpleBoxPosition(n))
            } ()
        } else for (var l = 0; l < e.length; l++) i.appendChild(e[l].displayState)
    },
    Ht.Parser = function(t, e, n) {
        n || (n = e, e = {}),
        e || (e = {}),
        this.window = t,
        this.vttjs = e,
    ...
    Ht.Parser.prototype = {
        ...
        parse: function(t) {
            ...
            try {
                ...
                if ("INITIAL" === r.state) {
                    ...
                    if (!s || !s[0]) throw new Pt(Pt.Errors.BadSignature);
                    r.state = "HEADER"
                }
                for (var a = !1; r.buffer;) {
                    ...
                    case "CUE":
                        try {
                            Rt(o, r.cue, r.regionList)
                        } catch(c) {
                            r.reportOrThrowError(c),
                            r.cue = null,
                            r.state = "BADCUE";
                            continue
                        }
        ...
        flush: function() {
            var t = this;
            try {
                if (t.buffer += t.decoder.decode(), (t.cue || "HEADER" === t.state) && (t.buffer += "\n\n", t.parse()), "INITIAL" === t.state) throw new Pt(Pt.Errors.BadSignature)
            } catch(e) {
    ...
    Wt.prototype.getCueAsHTML = function() {
    ...
    eo = function(t) {
        function e(n) {
            ...
            r = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function() {};
            Zn(this, e),
            i.reportTouchActivity = !1;
            var o = ei(this, t.call(this, n, i, r));
            ...
            ["Text", "Audio", "Video"].forEach(function(t) { ! 1 === i["native" + t + "Tracks"] && (o["featuresNative" + t + "Tracks"] = !1)
            }),
            ...
            o.autoRemoteTextTracks_ = new Vr.text.ListClass,
        ...
        e.prototype.trackProgress = function(t) {
            this.stopTrackingProgress(),
            this.progressInterval = this.setInterval(Si(this,
            function() {
        ...
        e.prototype.error = function(t) {
            return t !== undefined && (this.error_ = new pt(t), this.trigger("error")),
            this.error_
        },
        ...
        e.prototype.addWebVttScript_ = function() {
            var t = this;
            if (!tn.WebVTT) if (sn.body.contains(this.el())) {
                if (!this.options_["vtt.js"] && c(to) && Object.keys(to).length > 0) return void this.trigger("vttjsloaded");
        ...
        e.prototype.createRemoteTextTrack = function(t) {
            ...
            return new Fr.remoteTextEl.TrackClass(e)
        },
        e.prototype.addRemoteTextTrack = function() {
            ...
            return ! 0 !== n && !1 !== n && (ci.warn('Calling addRemoteTextTrack without explicitly setting the "manualCleanup" parameter to `true` is deprecated and default to `false` in future version of video.js'), n = !0),
        ...
        e.getTech = function(t) {
            if (t) return t = it(t),
            e.techs_ && e.techs_[t] ? e.techs_[t] : tn && tn.videojs && tn.videojs[t] ? (ci.warn("The " + t + " tech was added to the videojs object when it should be registered using videojs.registerTech(name, tech)"), tn.videojs[t]) : void 0
        },
        e
    } (Bi);
    Vr.names.forEach(function(t) {
        var e = Vr[t];
        eo.prototype[e.getterName] = function() {
            return this[e.privateName] = this[e.privateName] || new e.ListClass,
            this[e.privateName]
        }
    }),
    eo.prototype.featuresVolumeControl = !0,
    eo.prototype.featuresMuteControl = !0,
    eo.prototype.featuresFullscreenResize = !1,
    eo.prototype.featuresPlaybackRate = !1,
    eo.prototype.featuresProgressEvents = !1,
    eo.prototype.featuresTimeupdateEvents = !1,
    eo.prototype.featuresNativeTextTracks = !1,
    eo.withSourceHandlers = function(t) {
        t.registerSourceHandler = function(e, n) {
            var i = t.sourceHandlers;
            i || (i = t.sourceHandlers = []),
            n === undefined && (n = i.length),
            i.splice(n, 0, e)
        },
        ...
        t.prototype.setSource = function(e) {
            ...
            n || (t.nativeSourceHandler ? n = t.nativeSourceHandler: ci.error("No source hander found for the current source.")),
    ...
    Bi.registerComponent("Tech", eo),
    eo.registerTech("Tech", eo),
    eo.defaultTechOrder_ = [];
    var no = {},
    io = {
        buffered: 1,
        currentTime: 1,
    ...
    oo = function jh(t) {
        if (Array.isArray(t)) {
            ...
            t.forEach(function(t) {
                t = jh(t),
                Array.isArray(t) ? e = e.concat(t) : l(t) && e.push(t)
            }),
            t = e
        } else t = "string" == typeof t && t.trim() ? [{
            src: t
        }] : l(t) && "string" == typeof t.src && t.src && t.src.trim() ? [t] : [];
        return t
    },
    so = function(t) {
        function e(n, i, r) {
    ...
    Bi.registerComponent("MediaLoader", so);
    var ao = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
        ...
        e.prototype.createEl = function() {
            ...
            n),
            "button" === e && ci.error("Creating a ClickableComponent with an HTML element of " + e + " is not supported; use a Button instead."),
            i = a({
                role: "button",
                "aria-live": "polite"
            },
        ...
        e.prototype.handleFocus = function(t) {
            G(sn, "keydown", Si(this, this.handleKeyPress))
        },
        ...
        e.prototype.handleBlur = function(t) {
            Y(sn, "keydown", Si(this, this.handleKeyPress))
        },
        e
    } (Bi);
    Bi.registerComponent("ClickableComponent", ao);
    var lo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return r.update(),
            n.on("posterchange", Si(r, r.update)),
            r
        }
        return ti(e, t),
        e.prototype.dispose = function() {
        ...
        e.prototype.createEl = function() {
            ...
            if (!On) {
                ...
                var n = b("div"),
                i = b("span");
                i.appendChild(this.fallbackImg_),
                n.appendChild(i),
                t.appendChild(n)
            }
            return t
    ...
    Bi.registerComponent("PosterImage", lo);
    var co = {
        monospace: "monospace",
    ...
    uo = function(t) {
        function e(n, i, r) {
            Zn(this, e);
            var o = ei(this, t.call(this, n, i, r));
            return n.on("loadstart", Si(o, o.toggleDisplay)),
            n.on("texttrackchange", Si(o, o.updateDisplay)),
            n.on("loadstart", Si(o, o.preselectTrack)),
            n.ready(Si(o,
            function() {
                if (n.tech_ && n.tech_.featuresNativeTextTracks) return void this.hide();
                n.on("fullscreenchange", Si(this, this.updateDisplay));
        ...
        e.prototype.preselectTrack = function() {
            ...
            e = this.player_.textTracks(), n = this.player_.cache_.selectedLanguage, i = void 0, r = void 0, o = void 0, s = 0; s < e.length; s++) {
                var a = e[s];
                n && n.enabled && n.language === a.language ? a.kind === n.kind ? o = a: o || (o = a) : n && !n.enabled ? (o = null, i = null, r = null) : a["default"] && ("descriptions" !== a.kind || i ? a.kind in t && !r && (r = a) : i = a)
            }
        ...
        e.prototype.clearDisplay = function() {
            "function" == typeof tn.WebVTT && tn.WebVTT.processCues(tn, [], this.el_)
        },
    ...
    Bi.registerComponent("TextTrackDisplay", uo);
    var ho = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
        }
        return ti(e, t),
        e.prototype.createEl = function() {
            return t.prototype.createEl.call(this, "div", {
    ...
    Bi.registerComponent("LoadingSpinner", ho);
    var po = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
        ...
        e.prototype.createEl = function(t) {
            ...
            n);
            var i = Bi.prototype.createEl.call(this, t, e, n);
        ...
        e.prototype.addChild = function(t) {
            ...
            return ci.warn("Adding an actionable (user controllable) child to a Button (" + n + ") is not supported; use a ClickableComponent instead."),
            Bi.prototype.addChild.call(this, t, e)
        },
        e.prototype.enable = function() {
    ...
    Bi.registerComponent("Button", po);
    var fo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    fo.prototype.controlText_ = "Play Video",
    Bi.registerComponent("BigPlayButton", fo);
    var yo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    Bi.registerComponent("CloseButton", yo);
    var go = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    go.prototype.controlText_ = "Play",
    Bi.registerComponent("PlayToggle", go);
    var vo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return r.throttledUpdateContent = Ii(Si(r, r.updateContent), 25),
        ...
        e.prototype.updateTextNode_ = function() {
            if (this.contentEl_) {
                ...
                this.textNode_ = sn.createTextNode(this.formattedTime_ || "0:00"),
    ...
    vo.prototype.controlText_ = "Time",
    Bi.registerComponent("TimeDisplay", vo);
    var mo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    mo.prototype.controlText_ = "Current Time",
    Bi.registerComponent("CurrentTimeDisplay", mo);
    var _o = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    _o.prototype.controlText_ = "Duration Time",
    Bi.registerComponent("DurationDisplay", _o);
    var bo = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
    ...
    Bi.registerComponent("TimeDivider", bo);
    var To = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    Bi.registerComponent("LiveDisplay", Co);
    var Eo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
        ...
        e.prototype.update = function() {
            if (this.el_) {
                ...
                e = this.bar;
                if (e) { ("number" != typeof t || t !== t || t < 0 || t === Infinity) && (t = 0);
    ...
    Bi.registerComponent("Slider", Eo);
    var wo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
        ...
        e.prototype.update = function(t) {
            ...
            for (var s = 0; s < e.length; s++) {
                ...
                l = e.end(s),
                c = r[s];
                c || (c = this.el_.appendChild(b()), r[s] = c),
                c.style.left = o(a, i),
                c.style.width = o(l - a, i)
            }
    ...
    Bi.registerComponent("LoadProgressBar", wo);
    var ko = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
    ...
    Bi.registerComponent("TimeTooltip", ko);
    var So = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
    ...
    Dn && !(Dn > 8) || dn || yn || So.prototype.options_.children.push("timeTooltip"),
    Bi.registerComponent("PlayProgressBar", So);
    var Io = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return r.update = Ii(Si(r, r.update), 25),
            r
        }
        return ti(e, t),
        e.prototype.createEl = function() {
        ...
        e.prototype.update = function(t, e) {
            ...
            this.rafId_ = this.requestAnimationFrame(function() {
                ...
                n.getChild("timeTooltip").update(t, e, r)
            })
        },
        e
    } (Bi);
    ...
    Bi.registerComponent("MouseTimeDisplay", Io);
    var Po = 30,
    xo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return r.update = Ii(Si(r, r.update), Po),
            ...
            r.on(n, ["ended", "pause", "waiting"],
            function() {
                r.clearInterval(r.updateInterval)
            }),
            r.on(n, ["timeupdate", "ended"], r.update),
            r
        }
        return ti(e, t),
        e.prototype.createEl = function() {
        ...
        e.prototype.update_ = function(t, e) {
            ...
            this.el_.setAttribute("aria-valuetext", this.localize("progress bar timing: currentTime={1} duration={2}", [oe(t, n), oe(n, n)], "{1} of {2}")),
    ...
    Dn && !(Dn > 8) || dn || yn || xo.prototype.options_.children.splice(1, 0, "mouseTimeDisplay"),
    xo.prototype.playerEvent = "timeupdate",
    Bi.registerComponent("SeekBar", xo);
    var Do = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return r.handleMouseMove = Ii(Si(r, r.handleMouseMove), 25),
            r.throttledHandleMouseSeek = Ii(Si(r, r.handleMouseSeek), 25),
            r.enable(),
            r
        }
        return ti(e, t),
    ...
    Bi.registerComponent("ProgressControl", Do);
    var Mo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    Bi.registerComponent("FullscreenToggle", Mo);
    var Ro = function(t, e) { ! e.tech_ || e.tech_.featuresVolumeControl || e.tech_.featuresMuteControl ? e.tech_ && e.tech_.featuresVolumeControl && t.addClass("enable-volume-control") : t.addClass("vjs-hidden"),
        t.on(e, "loadstart",
        function() {
    ...
    Bi.registerComponent("VolumeLevel", Ao);
    var Oo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    Bi.registerComponent("VolumeBar", Oo);
    var jo = function(t) {
        function e(n) {
            var i = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
            Zn(this, e),
            i.vertical = i.vertical || !1,
            ("undefined" == typeof i.volumeBar || c(i.volumeBar)) && (i.volumeBar = i.volumeBar || {},
            i.volumeBar.vertical = i.vertical);
            var r = ei(this, t.call(this, n, i));
            return Ro(r, n),
            r.throttledHandleMouseMove = Ii(Si(r, r.handleMouseMove), 25),
            r.on("mousedown", r.handleMouseDown),
            r.on("touchstart", r.handleMouseDown),
            r.on(r.volumeBar, ["focus", "slideractive"],
            function() {
                r.volumeBar.addClass("vjs-slider-active"),
                r.addClass("vjs-slider-active"),
                r.trigger("slideractive")
            }),
            r.on(r.volumeBar, ["blur", "sliderinactive"],
            function() {
    ...
    Bi.registerComponent("VolumeControl", jo);
    var Lo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return Ro(r, n),
            r.on(n, ["loadstart", "volumechange"], r.update),
            r
        }
        return ti(e, t),
        e.prototype.buildCSSClass = function() {
    ...
    Bi.registerComponent("MuteToggle", Lo);
    var No = function(t) {
        function e(n) {
            var i = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
            Zn(this, e),
            "undefined" != typeof i.inline ? i.inline = i.inline: i.inline = !0,
            ("undefined" == typeof i.volumeControl || c(i.volumeControl)) && (i.volumeControl = i.volumeControl || {},
        ...
        e.prototype.sliderActive_ = function() {
            yn || dn || this.addClass("vjs-slider-active")
        },
        e.prototype.sliderInactive_ = function() {
            yn || dn || this.removeClass("vjs-slider-active")
        },
        e.prototype.createEl = function() {
    ...
    Bi.registerComponent("VolumePanel", No);
    var Bo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    var Fo = function(t) {
        ...
        e.prototype.createMenu = function() {
            var t = new Bo(this.player_, {
                menuButton: this
            });
            if (this.hideThreshold_ = 0, this.options_.title) {
                var e = b("li", {
                    className: "vjs-menu-title",
                    innerHTML: it(this.options_.title),
                    tabIndex: -1
                });
        ...
        e.prototype.buildWrapperCSSClass = function() {
            ...
            "vjs-menu-button " + e + " " + po.prototype.buildCSSClass() + " " + t.prototype.buildCSSClass.call(this)
        },
        e.prototype.buildCSSClass = function() {
            var e = "vjs-menu-button";
            return ! 0 === this.options_.inline ? e += "-inline": e += "-popup",
        ...
        e.prototype.handleClick = function(t) {
            this.one(this.menu.contentEl(), "mouseleave", Si(this,
            function(t) {
                this.unpressButton(),
                this.el_.blur()
            })),
        ...
        e.prototype.pressButton = function() {
            if (this.enabled_) {
                if (this.buttonPressed_ = !0, this.menu.lockShowing(), this.menuButton_.el_.setAttribute("aria-expanded", "true"), dn && m()) return;
                this.menu.focus()
            }
        },
    ...
    Bi.registerComponent("MenuButton", Fo);
    var Vo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = i.tracks,
            o = ei(this, t.call(this, n, i));
            if (o.items.length <= 1 && o.hide(), !r) return ei(o);
            var s = Si(o, o.update);
    ...
    Bi.registerComponent("TrackButton", Vo);
    var Ho = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
        ...
        e.prototype.createEl = function(e, n, i) {
            ...
            t.prototype.createEl.call(this, "li", a({
    ...
    Bi.registerComponent("MenuItem", Ho);
    var Uo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = i.track,
            ...
            function() {
                ...
                s.on(["tap", "click"],
                function() {
                    if ("object" !== Jn(tn.Event)) try {
                        c = new tn.Event("change")
                    } catch(t) {}
                    c || (c = sn.createEvent("Event"), c.initEvent("change", !0, !0)),
                    o.dispatchEvent(c)
                })
            }
        ...
        e.prototype.handleClick = function(e) {
            ...
            if (i || (i = [n]), t.prototype.handleClick.call(this, e), r) for (var o = 0; o < r.length; o++) {
                var s = r[o];
    ...
    Bi.registerComponent("TextTrackMenuItem", Uo);
    var qo = function(t) {
        function e(n, i) {
            return Zn(this, e),
            i.track = {
    ...
    Bi.registerComponent("OffTextTrackMenuItem", qo);
    var zo = function(t) {
        function e(n) {
            var i = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
            return Zn(this, e),
        ...
        e.prototype.createItems = function() {
            var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [],
            e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : Uo,
            n = void 0;
    ...
    Bi.registerComponent("TextTrackButton", zo);
    var Wo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = i.track,
            ...
            var a = ei(this, t.call(this, n, i));
            return a.track = r,
            a.cue = o,
            r.addEventListener("cuechange", Si(a, a.update)),
            a
        }
        return ti(e, t),
        e.prototype.handleClick = function(e) {
    ...
    Bi.registerComponent("ChaptersTrackMenuItem", Wo);
    var Ko = function(t) {
        function e(n, i, r) {
            return Zn(this, e),
            ei(this, t.call(this, n, i, r))
        }
        return ti(e, t),
        e.prototype.buildCSSClass = function() {
        ...
        e.prototype.getMenuCaption = function() {
            return this.track_ && this.track_.label ? this.track_.label: this.localize(it(this.kind_))
        },
        e.prototype.createMenu = function() {
    ...
    Ko.prototype.kind_ = "chapters",
    Ko.prototype.controlText_ = "Chapters",
    Bi.registerComponent("ChaptersButton", Ko);
    var Qo = function(t) {
        function e(n, i, r) {
            Zn(this, e);
            var o = ei(this, t.call(this, n, i, r)),
    ...
    Bi.registerComponent("DescriptionsButton", Qo);
    var Xo = function(t) {
        function e(n, i, r) {
            return Zn(this, e),
            ei(this, t.call(this, n, i, r))
    ...
    Xo.prototype.kind_ = "subtitles",
    Xo.prototype.controlText_ = "Subtitles",
    Bi.registerComponent("SubtitlesButton", Xo);
    var $o = function(t) {
        function e(n, i) {
            Zn(this, e),
            i.track = {
    ...
    Bi.registerComponent("CaptionSettingsMenuItem", $o);
    var Go = function(t) {
        function e(n, i, r) {
            return Zn(this, e),
            ei(this, t.call(this, n, i, r))
    ...
    Go.prototype.kind_ = "captions",
    Go.prototype.controlText_ = "Captions",
    Bi.registerComponent("CaptionsButton", Go);
    var Yo = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
        ...
        e.prototype.createEl = function(e, n, i) {
            ...
            r += "</span>",
            t.prototype.createEl.call(this, e, a({
                innerHTML: r
            },
            n), i)
        },
    ...
    Bi.registerComponent("SubsCapsMenuItem", Yo);
    var Jo = function(t) {
        function e(n) {
            var i = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
            Zn(this, e);
            ...
            r.menuButton_.controlText(it(r.label_)),
            r
        }
        return ti(e, t),
        e.prototype.buildCSSClass = function() {
        ...
        e.prototype.createItems = function() {
            ...
            e = t.prototype.createItems.call(this, e, Yo)
        },
        e
    } (zo);
    Jo.prototype.kinds_ = ["captions", "subtitles"],
    Jo.prototype.controlText_ = "Subtitles",
    Bi.registerComponent("SubsCapsButton", Jo);
    var Zo = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = i.track,
    ...
    ts.prototype.controlText_ = "Audio Track",
    Bi.registerComponent("AudioTrackButton", ts);
    var es = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = i.rate,
    ...
    es.prototype.contentElType = "button",
    Bi.registerComponent("PlaybackRateMenuItem", es);
    var ns = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
        ...
        e.prototype.createMenu = function() {
            var t = new Bo(this.player()),
            e = this.playbackRates();
            if (e) for (var n = e.length - 1; n >= 0; n--) t.addChild(new es(this.player(), {
                rate: e[n] + "x"
            }));
            return t
        },
    ...
    ns.prototype.controlText_ = "Playback Rate",
    Bi.registerComponent("PlaybackRateMenuButton", ns);
    var is = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
    ...
    Bi.registerComponent("Spacer", is);
    var rs = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
    ...
    Bi.registerComponent("CustomControlSpacer", rs);
    var os = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
    ...
    ss.prototype.options_ = ot(Zi.prototype.options_, {
        pauseOnOpen: !1,
        fillAlways: !0,
        temporary: !1,
        uncloseable: !0
    }),
    Bi.registerComponent("ErrorDisplay", ss);
    var as = ["#000", "Black"],
    ls = ["#00F", "Blue"],
    cs = ["#0FF", "Cyan"],
    us = ["#0F0", "Green"],
    ...
    ms = {
        backgroundColor: {
            ...
            label: "Color",
            options: [as, ds, ps, us, ls, fs, hs, cs]
        },
        backgroundOpacity: {
        ...
        color: {
            ...
            label: "Color",
            options: [ds, as, ps, us, ls, fs, hs, cs]
        },
        edgeStyle: {
    ...
    ms.windowColor.options = ms.backgroundColor.options;
    var _s = function(t) {
        function e(n, i) {
            Zn(this, e),
            i.temporary = !1;
            var r = ei(this, t.call(this, n, i));
            return r.updateDisplay = Si(r, r.updateDisplay),
            r.fill(),
            ...
            r.setDefaults(),
            i.persistTextTrackSettings === undefined && (r.options_.persistTextTrackSettings = r.options_.playerOptions.persistTextTrackSettings),
        ...
        e.prototype.createElSelect_ = function(t) {
            var e = this,
            n = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "",
            i = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "label",
            r = ms[t],
            o = r.id.replace("%s", this.id_);
            return ["<" + i + ' id="' + o + '" class="' + ("label" === i ? "vjs-label": "") + '">', this.localize(r.label), "</" + i + ">", '<select aria-labelledby="' + ("" !== n ? n + " ": "") + o + '">'].concat(r.options.map(function(t) {
                var i = o + "-" + t[1];
                return ['<option id="' + i + '" value="' + t[0] + '" ', 'aria-labelledby="' + ("" !== n ? n + " ": "") + o + " " + i + '">', e.localize(t[1]), "</option>"].join("")
            })).concat("</select>").join("")
        },
        ...
        e.prototype.getValues = function() {
            ...
            return s(ms,
            function(e, n, i) {
                var r = ae(t.$(n.selector), n.parser);
                return r !== undefined && (e[i] = r),
                e
            },
            {})
        },
        ...
        e.prototype.restoreSettings = function() {
            var t = void 0;
            try {
                t = JSON.parse(tn.localStorage.getItem("vjs-text-track-settings"))
            } catch(e) {
                ci.warn(e)
            }
            t && this.setValues(t)
        ...
        e.prototype.saveSettings = function() {
            if (this.options_.persistTextTrackSettings) {
                ...
                try {
                    Object.keys(t).length ? tn.localStorage.setItem("vjs-text-track-settings", JSON.stringify(t)) : tn.localStorage.removeItem("vjs-text-track-settings")
                } catch(e) {
                    ci.warn(e)
                }
            }
    ...
    Bi.registerComponent("TextTrackSettings", _s);
    var bs = ni(["Text Tracks are being loaded from another origin but the crossorigin attribute isn't used.\n            This may prevent text tracks from loading."], ["Text Tracks are being loaded from another origin but the crossorigin attribute isn't used.\n            This may prevent text tracks from loading."]),
    Ts = function(t) {
        function e(n, i, r) {
            Zn(this, e);
            var o = ei(this, t.call(this, n, i, r)),
            s = i.source,
            a = !1;
            if (s && (o.el_.currentSrc !== s.src || i.tag && 3 === i.tag.initNetworkState_) ? o.setSource(s) : o.handleLateInit_(o.el_), o.el_.hasChildNodes()) {
                for (var l = o.el_.childNodes,
                c = l.length,
                u = []; c--;) {
                    var h = l[c];
                    "track" === h.nodeName.toLowerCase() && (o.featuresNativeTextTracks ? (o.remoteTextTrackEls().addTrackElement_(h), o.remoteTextTracks().addTrack(h.track), o.textTracks().addTrack(h.track), a || o.el_.hasAttribute("crossorigin") || !vr(h.src) || (a = !0)) : u.push(h))
                }
                for (var p = 0; p < u.length; p++) o.el_.removeChild(u[p])
            }
            return o.proxyNativeTracks_(),
            o.featuresNativeTextTracks && a && ci.warn(ui(bs)),
            o.restoreMetadataTracksInIOSNativePlayer_(),
            (An || hn || wn) && !0 === i.nativeControlsForTouch && o.setControls(!0),
        ...
        e.prototype.createEl = function() {
            ...
            if (!t || !this.options_.playerElIngest && !this.movingMediaElementInDOM) {
                if (t) {
                    ...
                    t = sn.createElement("video");
                    var i = this.options_.tag && P(this.options_.tag),
                    r = ot({},
                    i);
                    An && !0 === this.options_.nativeControlsForTouch || delete r.controls,
                    I(t, a(r, {
            ...
            "undefined" != typeof this.options_.preload && D(t, "preload", this.options_.preload);
            for (var o = ["loop", "muted", "playsinline", "autoplay"], s = 0; s < o.length; s++) {
                var l = o[s],
                c = this.options_[l];
                void 0 !== c && (c ? D(t, l, l) : M(t, l), t[l] = c)
            }
            return t
        },
        ...
        e.prototype.setCurrentTime = function(t) {
            try {
                ...
                ci(e, "Video is not ready. (Video.js)")
            }
        },
        e.prototype.duration = function() {
            var t = this;
            if (this.el_.duration === Infinity && yn && In && 0 === this.el_.currentTime) {
                var e = function n() {
        ...
        e.prototype.supportsFullScreen = function() {
            if ("function" == typeof this.el_.webkitEnterFullScreen) {
                var t = tn.navigator && tn.navigator.userAgent || "";
        ...
        e.prototype.getVideoPlaybackQuality = function() {
            ...
            tn.performance && "function" == typeof tn.performance.now ? t.creationTime = tn.performance.now() : tn.performance && tn.performance.timing && "number" == typeof tn.performance.timing.navigationStart && (t.creationTime = tn.Date.now() - tn.performance.timing.navigationStart),
            t
        },
        e
    } (eo);
    if (g()) {
        Ts.TEST_VID = sn.createElement("video");
        var Cs = sn.createElement("track");
        Cs.kind = "captions",
        Cs.srclang = "en",
        Cs.label = "English",
        Ts.TEST_VID.appendChild(Cs)
    }
    Ts.isSupported = function() {
        try {
            Ts.TEST_VID.volume = .5
        } catch(t) {
            return ! 1
        }
        return ! (!Ts.TEST_VID || !Ts.TEST_VID.canPlayType)
    },
    Ts.canPlayType = function(t) {
        return Ts.TEST_VID.canPlayType(t)
    },
    Ts.canPlaySource = function(t, e) {
        return Ts.canPlayType(t.type)
    },
    Ts.canControlVolume = function() {
        try {
            var t = Ts.TEST_VID.volume;
            return Ts.TEST_VID.volume = t / 2 + .1,
            t !== Ts.TEST_VID.volume
        } catch(e) {
            return ! 1
        }
    },
    Ts.canControlMute = function() {
        try {
            var t = Ts.TEST_VID.muted;
            return Ts.TEST_VID.muted = !0,
            t !== Ts.TEST_VID.muted
        } catch(e) {
            return ! 1
        }
    },
    Ts.canControlPlaybackRate = function() {
        if (yn && In && Pn < 58) return ! 1;
        try {
            var t = Ts.TEST_VID.playbackRate;
            return Ts.TEST_VID.playbackRate = t / 2 + .1,
            t !== Ts.TEST_VID.playbackRate
        } catch(e) {
            return ! 1
        }
    },
    Ts.supportsNativeTextTracks = function() {
        return Rn
    },
    Ts.supportsNativeVideoTracks = function() {
        return ! (!Ts.TEST_VID || !Ts.TEST_VID.videoTracks)
    },
    Ts.supportsNativeAudioTracks = function() {
        return ! (!Ts.TEST_VID || !Ts.TEST_VID.audioTracks)
    },
    Ts.Events = ["loadstart", "suspend", "abort", "error", "emptied", "stalled", "loadedmetadata", "loadeddata", "canplay", "canplaythrough", "playing", "waiting", "seeking", "seeked", "ended", "durationchange", "timeupdate", "progress", "play", "pause", "ratechange", "resize", "volumechange"],
    Ts.prototype.featuresVolumeControl = Ts.canControlVolume(),
    Ts.prototype.featuresMuteControl = Ts.canControlMute(),
    Ts.prototype.featuresPlaybackRate = Ts.canControlPlaybackRate(),
    Ts.prototype.movingMediaElementInDOM = !dn,
    Ts.prototype.featuresFullscreenResize = !0,
    Ts.prototype.featuresProgressEvents = !0,
    Ts.prototype.featuresTimeupdateEvents = !0,
    Ts.prototype.featuresNativeTextTracks = Ts.supportsNativeTextTracks(),
    Ts.prototype.featuresNativeVideoTracks = Ts.supportsNativeVideoTracks(),
    Ts.prototype.featuresNativeAudioTracks = Ts.supportsNativeAudioTracks();
    var Es = Ts.TEST_VID && Ts.TEST_VID.constructor.prototype.canPlayType,
    ws = /^application\/(?:x-|vnd\.apple\.)mpegurl/i,
    ks = /^video\/mp4/i;
    Ts.patchCanPlayType = function() {
        gn >= 4 && !kn ? Ts.TEST_VID.constructor.prototype.canPlayType = function(t) {
            return t && ws.test(t) ? "maybe": Es.call(this, t)
        }: En && (Ts.TEST_VID.constructor.prototype.canPlayType = function(t) {
            return t && ks.test(t) ? "maybe": Es.call(this, t)
        })
    },
    Ts.unpatchCanPlayType = function() {
        var t = Ts.TEST_VID.constructor.prototype.canPlayType;
        return Ts.TEST_VID.constructor.prototype.canPlayType = Es,
        t
    },
    Ts.patchCanPlayType(),
    Ts.disposeMediaElement = function(t) {
        if (t) {
    ...
    Ts.resetMediaElement = function(t) {
        if (t) {
    ...
    ["muted", "defaultMuted", "autoplay", "loop", "playsinline"].forEach(function(t) {
        Ts.prototype["set" + it(t)] = function(e) {
            this.el_[t] = e,
    ...
    eo.withSourceHandlers(Ts),
    Ts.nativeSourceHandler = {},
    Ts.nativeSourceHandler.canPlayType = function(t) {
        try {
            return Ts.TEST_VID.canPlayType(t)
        } catch(e) {
            return ""
    ...
    Ts.nativeSourceHandler.canHandleSource = function(t, e) {
        if (t.type) return Ts.nativeSourceHandler.canPlayType(t.type);
        if (t.src) {
            var n = gr(t.src);
            return Ts.nativeSourceHandler.canPlayType("video/" + n)
        }
        return ""
    },
    Ts.nativeSourceHandler.handleSource = function(t, e, n) {
        e.setSrc(t.src)
    },
    Ts.nativeSourceHandler.dispose = function() {},
    Ts.registerSourceHandler(Ts.nativeSourceHandler),
    eo.registerTech("Html5", Ts);
    var Ss = ni(["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "], ["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "]),
    Is = ["progress", "abort", "suspend", "emptied", "stalled", "loadedmetadata", "loadeddata", "timeupdate", "ratechange", "resize", "volumechange", "texttrackchange"],
    Ps = function(t) {
        function e(n, i, r) {
            if (Zn(this, e), n.id = n.id || "vjs_video_" + q(), i = a(e.getTagSettings(n), i), i.initChildren = !1, i.createEl = !1, i.evented = !1, i.reportTouchActivity = !1, !i.language) if ("function" == typeof n.closest) {
            ...
            var l = ei(this, t.call(this, null, i, r));
            ...
            if (l.tag = n, l.tagAttributes = n && P(n), l.language(l.options_.language), i.languages) {
                var c = {};
            ...
            dn || yn || l.addClass("vjs-workinghover"),
            e.players[l.id_] = l,
            l.userActive(!0),
        ...
        e.prototype.createEl = function() {
            ...
            var o = P(e);
            if (r) {
                for (n = this.el_ = e, e = this.tag = sn.createElement("video"); n.children.length;) e.appendChild(n.firstChild);
                E(n, "video-js") || w(n, "video-js"),
                n.appendChild(e),
            ...
            if (e.setAttribute("tabindex", "-1"), e.removeAttribute("width"), e.removeAttribute("height"), Object.getOwnPropertyNames(o).forEach(function(t) {
                "class" === t ? (n.className += " " + o[t], r && (e.className += " " + o[t])) : (n.setAttribute(t, o[t]), r && e.setAttribute(t, o[t]))
            }), e.playerId = e.id, e.id += "_html5_api", e.className = "vjs-tech", e.player = n.player = this, this.addClass("vjs-paused"), !0 !== tn.VIDEOJS_NO_DYNAMIC_STYLE) {
                this.styleEl_ = wi("vjs-styles-dimensions");
                var s = pi(".vjs-styles-defaults"),
                a = pi("head");
            ...
            e.parentNode && !i && e.parentNode.insertBefore(n, e),
            C(e, n),
        ...
        e.prototype.dimension = function(t, e, n) {
            var i = t + "_";
            if (e === undefined) return this[i] || 0;
            if ("" === e) return this[i] = undefined,
            void this.updateStyleEl_();
            var r = parseFloat(e);
            if (isNaN(r)) return void ci.error('Improper value "' + e + '" supplied for for ' + t);
            this[i] = r,
            this.updateStyleEl_(),
        ...
        e.prototype.updateStyleEl_ = function() {
            if (!0 === tn.VIDEOJS_NO_DYNAMIC_STYLE) {
            ...
            var a = o.split(":"),
            l = a[1] / a[0];
            i = this.width_ !== undefined ? this.width_: this.height_ !== undefined ? this.height_ / l: this.videoWidth() || 300,
            r = this.height_ !== undefined ? this.height_: i * l,
        ...
        e.prototype.loadTech_ = function(t, e) {
            ...
            "Html5" !== i && this.tag && (eo.getTech("Html5").disposeMediaElement(this.tag), this.tag.player = null, this.tag = null),
            this.techName_ = i,
            this.isReady_ = !1;
            var o = {
                source: e,
            ...
            this.tech_.ready(Si(this, this.handleTechReady_), !0),
            Yi.jsonToTextTracks(this.textTracksJson_ || [], this.tech_),
            Is.forEach(function(t) {
                n.on(n.tech_, t, n["handleTech" + it(t) + "_"])
            }),
            ...
            this.tech_.el().parentNode === this.el() || "Html5" === i && this.tag || C(this.tech_.el(), this.el()),
        ...
        e.prototype.unloadTech_ = function() {
            ...
            this.textTracksJson_ = Yi.textTracksToJson(this.tech_),
            this.isReady_ = !1,
            this.tech_.dispose(),
            this.tech_ = !1
        },
        e.prototype.tech = function(t) {
            return t === undefined && ci.warn(ui(Ss)),
            this.tech_
        },
        ...
        e.prototype.handleTechReady_ = function() {
            if (this.triggerReady(), this.cache_.volume && this.techCall_("setVolume", this.cache_.volume), this.handleTechPosterChange_(), this.handleTechDurationChange_(), (this.src() || this.currentSrc()) && this.tag && this.options_.autoplay && this.paused()) try {
                ...
                ci("deleting tag.poster throws in some browsers", t)
            }
        },
        ...
        e.prototype.handleTechFirstPlay_ = function() {
            this.options_.starttime && (ci.warn("Passing the `starttime` option to the player will be deprecated in 6.0"), this.currentTime(this.options_.starttime)),
        ...
        e.prototype.documentFullscreenChange_ = function(t) {
            var e = Fi;
            this.isFullscreen(sn[e.fullscreenElement]),
            !1 === this.isFullscreen() && Y(sn, e.fullscreenchange, Si(this, this.documentFullscreenChange_)),
            qi || this.trigger("fullscreenchange")
        },
        ...
        e.prototype.techCall_ = function(t, e) {
            this.ready(function() {
                if (t in ro) return te(this.middleware_, this.tech_, t, e);
                try {
        ...
        e.prototype.techGet_ = function(t) {
            if (this.tech_ && this.tech_.isReady_) {
                if (t in io) return Zt(this.middleware_, this.tech_, t);
                try {
                    return this.tech_[t]()
                } catch(e) {
                    if (this.tech_[t] === undefined) throw ci("Video.js: " + t + " method not defined for " + this.techName_ + " playback technology.", e),
                    e;
                    if ("TypeError" === e.name) throw ci("Video.js: " + t + " unavailable on " + this.techName_ + " playback technology element.", e),
        ...
        e.prototype.isFullscreen = function(t) {
            return t !== undefined ? (this.isFullscreen_ = !!t, void this.toggleFullscreenClass_()) : !!this.isFullscreen_
        },
        e.prototype.requestFullscreen = function() {
            var t = Fi;
            this.isFullscreen(!0),
            t.requestFullscreen ? (G(sn, t.fullscreenchange, Si(this, this.documentFullscreenChange_)), this.el_[t.requestFullscreen]()) : this.tech_.supportsFullScreen() ? this.techCall_("enterFullScreen") : (this.enterFullWindow(), this.trigger("fullscreenchange"))
        },
        e.prototype.exitFullscreen = function() {
            var t = Fi;
            this.isFullscreen(!1),
            t.requestFullscreen ? sn[t.exitFullscreen]() : this.tech_.supportsFullScreen() ? this.techCall_("exitFullScreen") : (this.exitFullWindow(), this.trigger("fullscreenchange"))
        },
        e.prototype.enterFullWindow = function() {
            this.isFullWindow = !0,
            this.docOrigOverflow = sn.documentElement.style.overflow,
            G(sn, "keydown", Si(this, this.fullWindowOnEscKey)),
            sn.documentElement.style.overflow = "hidden",
            w(sn.body, "vjs-full-window"),
        ...
        e.prototype.exitFullWindow = function() {
            this.isFullWindow = !1,
            Y(sn, "keydown", this.fullWindowOnEscKey),
            sn.documentElement.style.overflow = this.docOrigOverflow,
            k(sn.body, "vjs-full-window"),
        ...
        e.prototype.canPlayType = function(t) {
            ...
            i = this.options_.techOrder; n < i.length; n++) {
                var r = i[n],
                o = eo.getTech(r);
                if (o || (o = Bi.getComponent(r)), o) {
                    if (o.isSupported() && (e = o.canPlayType(t))) return e
                } else ci.error('The "' + r + '" tech is undefined. Skipped browser support check for that tech.')
            }
            return ""
        },
        e.prototype.selectSource = function(t) {
            ...
            n = this.options_.techOrder.map(function(t) {
                return [t, eo.getTech(t)]
            }).filter(function(t) {
                var e = t[0],
                n = t[1];
                return n ? n.isSupported() : (ci.error('The "' + e + '" tech is undefined. Skipped browser support check for that tech.'), !1)
            }),
            i = function(t, e, n) {
                var i = void 0;
            ...
            r = function(t, n) {
                var i = t[0];
                if (t[1].canPlaySource(n, e.options_[i.toLowerCase()])) return {
                    source: n,
                    tech: i
                }
            };
            return (this.options_.sourceOrder ? i(t, n,
            function(t) {
                return function(e, n) {
                    return t(n, e)
                }
        ...
        e.prototype.src = function(t) {
            ...
            Yt(this, n[0],
            function(t, i) {
                if (e.middleware_ = i, e.src_(t)) return n.length > 1 ? e.src(n.slice(1)) : (e.setTimeout(function() {
                    this.error({
                        code: 4,
                        message: this.localize(this.options_.notSupportedMessage)
                    })
        ...
        e.prototype.forceAutoplayInChrome_ = function() {
            this.paused() && (this.autoplay() || this.options_.autoplay) && In && !yn && this.play()
        },
        ...
        e.prototype.error = function(t) {
            return t === undefined ? this.error_ || null: null === t ? (this.error_ = t, this.removeClass("vjs-error"), void(this.errorDisplay && this.errorDisplay.close())) : (this.error_ = new pt(t), this.addClass("vjs-error"), ci.error("(CODE:" + this.error_.code + " " + pt.errorTypes[this.error_.code] + ")", this.error_.message, this.error_), void this.trigger({
                type: "error",
                data: this.error_
            }))
        },
        ...
        e.prototype.listenForUserActivity_ = function() {
            ...
            e = void 0,
            n = void 0,
            i = Si(this, this.reportUserActivity),
            r = function(t) {
        ...
        e.getTagSettings = function(t) {
            ...
            n = P(t),
            i = n["data-setup"];
            if (E(t, "vjs-fluid") && (n.fluid = !0), null !== i) {
                var r = Qi(i || "{}"),
                o = r[0],
                s = r[1];
                o && ci.error(o),
            ...
            if (a(e, n), t.hasChildNodes()) for (var l = t.childNodes,
            c = 0,
            u = l.length; c < u; c++) {
                var h = l[c],
    ...
    Vr.names.forEach(function(t) {
        var e = Vr[t];
        Ps.prototype[e.getterName] = function() {
    ...
    Ps.prototype.options_ = {
        ...
        language: xs && (xs.languages && xs.languages[0] || xs.userLanguage || xs.language) || "en",
        languages: {},
    ...
    Is.forEach(function(t) {
        Ps.prototype["handleTech" + it(t) + "_"] = function() {
            return this.trigger(t)
        }
    }),
    Bi.registerComponent("Player", Ps);
    var Ds = {},
    Ms = function(t) {
        return Ds.hasOwnProperty(t)
    },
    Rs = function(t) {
        return Ms(t) ? Ds[t] : undefined
    },
    As = function(t, e) {
    ...
    Ls = function(t, e) {
        ...
        function() {
            ...
            var o = new(Function.prototype.bind.apply(e, [null].concat([this].concat(i))));
    ...
    Ns = function() {
        function t(e) {
            if (Zn(this, t), this.constructor === t) throw new Error("Plugin must be sub-classed; not directly instantiated.");
            this.player = e,
            et(this),
            delete this.trigger,
            nt(this, this.constructor.defaultState),
            As(e, this.name),
            this.dispose = Si(this, this.dispose),
        ...
        t.registerPlugin = function(e, n) {
            if ("string" != typeof e) throw new Error('Illegal plugin name, "' + e + '", must be a string, was ' + (void 0 === e ? "undefined": Jn(e)) + ".");
            if (Ms(e)) ci.warn('A plugin named "' + e + '" already exists. You may want to avoid re-registering plugins!');
            else if (Ps.prototype.hasOwnProperty(e)) throw new Error('Illegal plugin name, "' + e + '", cannot share a name with an existing player method!');
            if ("function" != typeof n) throw new Error('Illegal plugin for "' + e + '", must be a function, was ' + (void 0 === n ? "undefined": Jn(n)) + ".");
            return Ds[e] = n,
            "plugin" !== e && (t.isBasic(n) ? Ps.prototype[e] = js(e, n) : Ps.prototype[e] = Ls(e, n)),
            n
        },
        t.deregisterPlugin = function(t) {
            if ("plugin" === t) throw new Error("Cannot de-register base plugin.");
            Ms(t) && (delete Ds[t], delete Ps.prototype[t])
        },
    ...
    Ns.getPlugin = Rs,
    Ns.BASE_PLUGIN_NAME = "plugin",
    Ns.registerPlugin("plugin", Ns),
    Ps.prototype.usingPlugin = function(t) {
        return !! this.activePlugins_ && !0 === this.activePlugins_[t]
    },
    Ps.prototype.hasPlugin = function(t) {
        return !! Ms(t)
    };
    var Bs = function(t, e) {
        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + (void 0 === e ? "undefined": Jn(e)));
        t.prototype = Object.create(e && e.prototype, {
            constructor: {
                value: t,
                enumerable: !1,
    ...
    Fs = function(t) {
        ...
        i = {};
        "object" === (void 0 === e ? "undefined": Jn(e)) ? (e.constructor !== Object.prototype.constructor && (n = e.constructor), i = e) : "function" == typeof e && (n = e),
        Bs(n, t);
        for (var r in i) i.hasOwnProperty(r) && (n.prototype[r] = i[r]);
        return n
    };
    if ("undefined" == typeof HTMLVideoElement && g() && (sn.createElement("video"), sn.createElement("audio"), sn.createElement("track"), sn.createElement("video-js")), ce.hooks_ = {},
    ce.hooks = function(t, e) {
        return ce.hooks_[t] = ce.hooks_[t] || [],
        e && (ce.hooks_[t] = ce.hooks_[t].concat(e)),
        ce.hooks_[t]
    },
    ce.hook = function(t, e) {
        ce.hooks(t, e)
    },
    ce.hookOnce = function(t, e) {
        ce.hooks(t, [].concat(e).map(function(e) {
            return function n() {
                return ce.removeHook(t, n),
                e.apply(undefined, arguments)
            }
        }))
    },
    ce.removeHook = function(t, e) {
        var n = ce.hooks(t).indexOf(e);
        return ! (n <= -1) && (ce.hooks_[t] = ce.hooks_[t].slice(), ce.hooks_[t].splice(n, 1), !0)
    },
    !0 !== tn.VIDEOJS_NO_DYNAMIC_STYLE && g()) {
        var Vs = pi(".vjs-styles-defaults");
        if (!Vs) {
            Vs = wi("vjs-styles-defaults");
            var Hs = pi("head");
            Hs && Hs.insertBefore(Vs, Hs.firstChild),
            ki(Vs, "\n      .video-js {\n        width: 300px;\n        height: 150px;\n      }\n\n      .vjs-fluid {\n        padding-top: 56.25%\n      }\n    ")
        }
    }
    tt(1, ce),
    ce.VERSION = "6.6.2",
    ce.options = Ps.prototype.options_,
    ce.getPlayers = function() {
        return Ps.players
    },
    ce.players = Ps.players,
    ce.getComponent = Bi.getComponent,
    ce.registerComponent = function(t, e) {
        eo.isTech(e) && ci.warn("The " + t + " tech was registered as a component. It should instead be registered using videojs.registerTech(name, tech)"),
        Bi.registerComponent.call(Bi, t, e)
    },
    ce.getTech = eo.getTech,
    ce.registerTech = eo.registerTech,
    ce.use = Gt,
    ce.browser = Yn,
    ce.TOUCH_ENABLED = An,
    ce.extend = Fs,
    ce.mergeOptions = ot,
    ce.bind = Si,
    ce.registerPlugin = Ns.registerPlugin,
    ce.plugin = function(t, e) {
        return ci.warn("videojs.plugin() is deprecated; use videojs.registerPlugin() instead"),
        Ns.registerPlugin(t, e)
    },
    ce.getPlugins = Ns.getPlugins,
    ce.getPlugin = Ns.getPlugin,
    ce.getPluginVersion = Ns.getPluginVersion,
    ce.addLanguage = function(t, e) {
        var n;
        return t = ("" + t).toLowerCase(),
        ce.options.languages = ot(ce.options.languages, (n = {},
        n[t] = e, n)),
        ce.options.languages[t]
    },
    ce.log = ci,
    ce.createTimeRange = ce.createTimeRanges = ut,
    ce.formatTime = oe,
    ce.parseUrl = fr,
    ce.isCrossOrigin = vr,
    ce.EventTarget = Pi,
    ...
    ["isEl", "isTextNode", "createEl", "hasClass", "addClass", "removeClass", "toggleClass", "setAttributes", "getAttributes", "emptyEl", "appendContent", "insertContent"].forEach(function(t) {
        ce[t] = function() {
            return ci.warn("videojs." + t + "() is deprecated; use videojs.dom." + t + "() instead"),
            fi[t].apply(null, arguments)
        }
    }),
    ce.computedStyle = p,
    ce.dom = fi,
    ...
    Xs = function() {
        ...
        for (var n, i, r = ue(t), o = 1; o < arguments.length; o++) {
            n = Object(arguments[o]);
            for (var s in n) Ks.call(n, s) && (r[s] = n[s]);
            if (Ws) {
                i = Ws(n);
                for (var a = 0; a < i.length; a++) Qs.call(n, i[a]) && (r[i[a]] = n[i[a]])
            }
        }
        return r
    },
    $s = new RegExp("%[a-f0-9]{2}", "gi"),
    Gs = new RegExp("(%[a-f0-9]{2})+", "gi"),
    Ys = function(t) {
    ...
    ta = function(t, e) {
        ...
        return t ? Object.keys(t).sort(e.sort).map(function(i) {
            ...
            if (null === r) return ge(i, e);
            if (Array.isArray(r)) {
                var o = [];
                return r.slice().forEach(function(t) {
                    t !== undefined && o.push(n(i, t, o.length))
                }),
                o.join("&")
            }
            return ge(i, e) + "=" + ge(r, e)
        }).filter(function(t) {
            return t.length > 0
        }).join("&") : ""
    },
    ...
    ra = function(e) {
        function n(i, r, o) {
            Zn(this, n),
            ci("MediaAsyncLoader initializing"),
            !(r.playerOptions && r.playerOptions.psign && t && t.isSupported()) || ce.browser.IS_TBS || ce.browser.IS_MQQB || ce.browser.IS_SAFARI || ce.browser.IE_VERSION && ce.browser.IE_VERSION < 11 || (r.playerOptions.overlayKey = xe(), r.playerOptions.overlayIv = xe(), r.playerOptions.dKeyDebug = r.dKeyDebug || !1);
            var s = ot({
                createEl: !1
            },
            r),
            a = ei(this, e.call(this, i, s, o)),
            l = s.playerOptions || s;
            return a.getInfo(l),
            i.loadVideoByID = Si(a, a.loadVideoByID),
            ci("MediaAsyncLoader initialized"),
            a
        }
        return ti(n, e),
        n.prototype.getInfo = function(t) {
            t && t.fileID && t.appID && (t.playDefinition ? this.getInfoV3(t) : t.sign || t.ssign ? this.getInfoV2(t) : this.getInfoV4(t))
        },
        n.prototype.getInfoV2 = function(t) {
            var e = this.player(),
            ...
            (r || 0 == r) && (a.us = r), (o || 0 == o) && (a.exper = o, e.trigger({
                type: "feature",
                data: "exper"
            })), e.trigger({
                type: "feature",
            ...
            ci("playcgi loading");
            var l = na.stringify(a);
            l && (n += (~n.indexOf("?") ? "&": "?") + l, n = n.replace("?&", "?")),
            this.getInfoRetryTimes = 0,
            this.getInfoRequest = function(t) {
                t && (n = n.replace("//playvideo.qcloud.com", "//bkplayvideo.qcloud.com")),
                Dn && Dn < 10 ? be(n, {
                    param: a,
                    timeout: 3e3,
                    prefix: "TcCallBack"
                },
                Si(this, this.onResult)) : xr({
                    url: n,
                    timeout: 3e3
                },
                Si(this, this.onResult))
            },
            this.getInfoRequest()
        },
        n.prototype.onResult = function(t, e, n) {
            try {
            ...
            var i = this.player();
            if (t) {
                if (ci("playcgi loaded failure"), this.getInfoRetryTimes < 3) return this.getInfoRetryTimes++,
                void this.getInfoRequest();
                if (this.getInfoRetryTimes < 6) return this.getInfoRetryTimes++,
                void this.getInfoRequest({
                    isBackup: !0
                });
                i.trigger({
                ...
                }), 0 != e.code) return ci("playcgi loaded failure"),
                void this.player().error({
                    code: e.code
                });
                ci("playcgi loaded success");
                var o = e.coverInfo,
                s = e.videoInfo,
                a = e.playerInfo;
                this.setPoster(o),
        ...
        n.prototype.getInfoV3 = function(t) {
            var e = this.player(),
            ...
            (r || 0 == r) && (a.us = r), o && (a.rlimit = o), e.trigger({
                type: "feature",
                data: "key"
            })),
            t.playerID && (a.playerid = t.playerID),
            ...
            this.getInfoRequest = function(t) {
                ...
                Si(this, this.onResultV3)) : xr({
                    url: n,
                    timeout: 3e3
                },
                Si(this, this.onResultV3))
            },
            this.getInfoRequest()
        },
        n.prototype.onResultV3 = function(t, e, n) {
            try {
            ...
            var i = this.player();
            if (t) {
                if (ci("playcgi v3 loaded failure"), this.getInfoRetryTimes < 3) return this.getInfoRetryTimes++,
                void this.getInfoRequest();
                if (this.getInfoRetryTimes < 6) return this.getInfoRetryTimes++,
                void this.getInfoRequest({
                    isBackup: !0
                ...
                }), 0 != e.code) return ci("playcgi v3 loaded failure"),
                void this.player().error({
                    code: e.code
                });
                ci("playcgi v3 loaded success");
                var o = e.mediaInfo,
                s = e.playerInfo;
                this.setPoster({
        ...
        n.prototype.setSrcV3 = function(t, e) {
            var n = this,
            i = this.player(),
            r = i.options_.plugins,
            o = i.DRM().options || r.DRM,
            s = void 0,
            a = void 0,
            l = void 0,
            c = [],
            ...
            if (e = e || (o ? o.skipPlan: ""), t.previewStreamingInfo && t.previewStreamingInfo.previewStreamingList.length > 0) t.previewStreamingInfo.previewStreamingList.forEach(function(t, e) {
                ...
                if (t.dynamicStreamingInfo.adaptiveStreamingInfoList.forEach(function(t, e) {
                    t.mineType = n.getMIMEType(t.url),
                    h[t.drmType.toLowerCase() || gr(t.url)] = t
                }), o && o.token ? (s = o.token, l = o.certificateUri, e = Mn && !l ? "fairplay": e, a = tn.encodeURIComponent(s)) : e = "all", (In || kn) && tn.navigator.requestMediaKeySystemAccess && h.widevine && "widevine" != e && "all" != e ? (c.push({
                    src: Ce(h.widevine.url),
                ...
                }), ci("DRM source widevine", c)) : Mn && !_n && h.fairplay && "fairplay" != e && "all" != e && (c.push({
                    src: Ce(h.fairplay.url),
                ...
                }), ci("DRM source fairplay", c)), h.simpleaes && "all" != e) {
            ...
            "all" !== e && (tn.setTimeout(function() {
                i.one("error", d)
            },
            0), i.one("playing",
            function(t) {}))
        },
        n.prototype.getInfoV4 = function(t) {
            var e = this.player(),
            n = this.assemblyPathV4("getplayinfo", t.appID, t.fileID),
            i = t.t,
            r = t.us,
            o = t.rlimit,
            s = t.psign,
            a = t.exper,
            l = {};
            t.ssign ? l.super_sign = t.ssign: s && (l = {
                t: i,
                psign: s
            },
            (r || 0 == r) && (l.us = r), o && (l.rlimit = o), a && (l.exper = a)),
            ...
            ci("playcgi v4 loading");
            var c = na.stringify(l);
            c && (n += (~n.indexOf("?") ? "&": "?") + c, n = n.replace("?&", "?"), t.overlayKey && t.overlayIv && (n += "&overlayKey=" + t.overlayKey + "&overlayIv=" + t.overlayIv)),
            this.getInfoRetryTimes = 0,
            this.getInfoRequest = function(t) {
                t && (n = n.replace("//playvideo.qcloud.com", "//bkplayvideo.qcloud.com")),
                Dn && Dn < 10 ? be(n, {
                ...
                Si(this, this.onResultV4)) : xr({
                    url: n,
                    timeout: 3e3
                },
                Si(this, this.onResultV4))
            },
            this.getInfoRequest()
        },
        n.prototype.onResultV4 = function(t, e, n) {
            try {
                n ? e = JSON.parse(n) : t || e.body || (t = new Error("ServerError"))
            } catch(c) {
                t = new Error("ServerError")
            ...
            var i = this.player();
            if (t) {
                if (ci("playcgi v4 loaded failure"), this.getInfoRetryTimes < 3) return this.getInfoRetryTimes++,
                void this.getInfoRequest();
                if (this.getInfoRetryTimes < 6) return this.getInfoRetryTimes++,
                void this.getInfoRequest({
                    isBackup: !0
                ...
                if (i.trigger({
                    ...
                    if (ci("playcgi v4 loaded failure"), e.code >= 2e3 && e.code < 3e3) {
                        if (this.getInfoRetryTimes < 3) return this.getInfoRetryTimes++,
                        void this.getInfoRequest();
                        if (this.getInfoRetryTimes < 6) return this.getInfoRetryTimes++,
                        void this.getInfoRequest({
                            isBackup: !0
                ...
                if (ci("playcgi v4 loaded success", e), 4 === e.version) {
                    var o = e.media;
                    this.setPoster({
                        coverUrl: o.basicInfo.coverUrl
                    }),
        ...
        n.prototype.setSrcV4 = function(t) {
            var e = this.player(),
            n = e.options_,
            i = void 0,
            r = void 0;
            if (!t.streamingInfo) return void this.player().error({
                code: 13,
                message: "no stream info"
            });
            if (t.streamingInfo) {
                if (n.hlsConfig ? (n.hlsConfig.startLevel || (n.hlsConfig.startLevel = 5), n.psign && (n.hlsConfig.overlayKey = e.options_.playerOptions.overlayKey, n.hlsConfig.overlayIv = e.options_.playerOptions.overlayIv, n.hlsConfig.dKeyDebug = e.options_.dKeyDebug)) : n.psign && e.options_.playerOptions.overlayKey ? n.hlsConfig = {
                    overlayKey: e.options_.playerOptions.overlayKey,
                    overlayIv: e.options_.playerOptions.overlayIv,
                    dKeyDebug: e.options_.dKeyDebug,
                    startLevel: 5
                }: n.hlsConfig = {
                    startLevel: 5
                },
                t.streamingInfo.plainOutput && (i = t.streamingInfo.plainOutput.url, r = t.streamingInfo.plainOutput.subStreams), t.streamingInfo.drmOutput && Array.isArray(t.streamingInfo.drmOutput)) {
                    var o = t.streamingInfo.drmOutput;
                    if ("SimpleAES" === o[0].type) {
                        var s = o[0].url.split("/");
                        s[s.length - 1] = "voddrm.token." + t.streamingInfo.drmToken + "." + s[s.length - 1],
                        i = s.join("/"),
                        r = o[0].subStreams
                    }
                }
        ...
        n.prototype.setQualityLabelList = function(t) {
        ...
        n.prototype.setLogo = function(t) {
            var e = this.player();
        ...
        n.prototype.setPoster = function(t) {
            var e = this.player();
            t && t.coverUrl ? e.poster(Ce(t.coverUrl)) : e.options_.playerOptions.poster || e.poster("")
        },
        n.prototype.setDots = function(t) {
            ...
            var i = e.options_.plugins;
            i && i.ProgressMarker && i.ProgressMarker.markers && i.ProgressMarker.markers.length > 0 && (e.options_.dots = e.options_.dots.concat(i.ProgressMarker.markers)),
            e.ProgressMarker().init()
        },
        n.prototype.setSrc = function(t) {
            var e = this.player(),
            n = t.videoInfo;
            if ((null != e.options_.definition || e.options_.definition != undefined) && n.transcodeList && n.transcodeList.length > 0) {
                ...
                var i = this.getSrcByDefinition(n, e.options_.definition);
                if (i) return e.src({
                    src: Ce(i.url),
                    type: this.getMIMEType(i.url)
                }),
                !0
            }
            ...
            e.MultiResolution().store(this.getMultiResolutionData(t));
                ...
                src: Ce(n.sourceVideo.url),
                type: this.getMIMEType(n.sourceVideo.url)
            }) : this.player().error({
                code: 13
            })
        },
        n.prototype.setPatch = function(t) {
            var e = this.player();
            t.patchInfo ? e.ImagePatch().init(t.patchInfo) : e.ImagePatch().reset()
        },
        n.prototype.setVttThumbnail = function(t) {
            var e = this.player();
            t.imageSpriteInfo && t.imageSpriteInfo.imageSpriteList ? e.ready(Si(this,
            function() {
                e.VttThumbnail().init({
                    vttUrl: Ce(t.imageSpriteInfo.imageSpriteList[0].webVttUrl)
                })
            })) : e.VttThumbnail().reset()
        },
        n.prototype.setVttThumbnailV4 = function(t) {
            var e = this.player();
            t.imageSpriteInfo && t.imageSpriteInfo.webVttUrl ? e.ready(Si(this,
            function() {
                e.VttThumbnail().init({
                    vttUrl: Ce(t.imageSpriteInfo.webVttUrl)
                })
            })) : e.VttThumbnail().reset()
        },
        n.prototype.setOriginDuration = function(t) {
            var e = this.player();
        ...
        n.prototype.setOriginDurationV4 = function(t) {
            var e = this,
            n = this.player();
            n.cache_.originDuration = t.basicInfo.duration,
            n.off("durationchange", this.keepOriginDuration),
            n.one("durationchange",
            function(t) {
                n.duration() > 0 && Math.floor(n.cache_.originDuration) !== Math.floor(n.duration()) && (e.keepOriginDuration(t), n.on("durationchange", e.keepOriginDuration))
            })
        },
        n.prototype.keepOriginDuration = function(t) {
            var e = this.player(),
            n = e.cache_.originDuration;
            Math.floor(n) !== Math.floor(e.duration()) && (ci("试看视频"), e.duration(Math.round(n)))
        },
        n.prototype.getMasterSouces = function(t) {
        ...
        n.prototype.getMultiResolutionData = function(t) {
            var e = {
                sources: {},
                labels: {},
                showOrder: [],
            ...
            n = [],
            i = t.videoInfo.transcodeList,
            r = this;
            return t.playerInfo.videoClassification.forEach(function(t, o) {
                i.length > 0 && (i = i.filter(function(i) {
                    if (! (t.definitionList.indexOf(i.definition) > -1)) return ! 0;
                    n[t.id] || (e.showOrder.push(t.id), e.labels[t.id] = t.name, n[t.id] = []),
                    n[t.id].push({
                        src: Ce(i.url),
                        type: r.getMIMEType(i.url)
                    })
                }))
            }),
            e.sources = n,
        ...
        n.prototype.getSrcByDefinition = function(t, e) {
            var n = t.transcodeList,
            i = t.sourceVideo;
            if (0 == e) return i;
            for (var r = 0; r < n.length; r++) if (n[r].definition == e) return n[r]
        },
        n.prototype.getMIMEType = function(t) {
            var e = Us[gr(t)];
            return e || (ci.error("MIME type no found! Ext = " + gr(t)), "")
        },
        n.prototype.assemblyPath = function(t, e, n) {
            var i = tn.location.protocol;
            return "http:" != i && "https:" != i && (i = "https:"),
            i + "//playvideo.qcloud.com/" + t + "/v2/" + e + "/" + n
        },
        n.prototype.assemblyPathV3 = function(t, e, n, i) {
            var r = tn.location.protocol;
            return "http:" != r && "https:" != r && (r = "https:"),
            r + "//playvideo.qcloud.com/" + t + "/v3/" + e + "/" + n + "/" + i
        },
        n.prototype.assemblyPathV4 = function(t, e, n) {
            var i = tn.location.protocol;
            return "http:" != i && "https:" != i && (i = "https:"),
            i + "//playvideo.qcloud.com/" + t + "/v4/" + e + "/" + n
        },
        n.prototype.customHost = function(t) {
            var e = this.player();
            e.options_.customHost && /^(?=^.{3,255}$)[a-zA-Z0-9][-a-zA-Z0-9]{0,62}(\.[a-zA-Z0-9][-a-zA-Z0-9]{0,62})+$/.test(e.options_.customHost) && (t.masterPlayList && (t.masterPlayList.url = Ee(t.masterPlayList.url, e.options_.customHost)), t.sourceVideo && (t.sourceVideo.url = Ee(t.sourceVideo.url, e.options_.customHost)), t.transcodeList.length > 0 && t.transcodeList.forEach(function(t, n) {
                t.url = Ee(t.url, e.options_.customHost)
            }), e.trigger({
                type: "feature",
                data: "customHost"
            }))
        },
        n.prototype.loadVideoByID = function(e) {
            var n = this.player();
            n.trigger({
                type: "loadnewvideo"
            }),
            !(e.psign && t && t.isSupported()) || ce.browser.IS_TBS || ce.browser.IS_MQQB || ce.browser.IS_SAFARI || ce.browser.IE_VERSION && ce.browser.IE_VERSION < 11 || (e.overlayKey = n.options_.playerOptions.overlayKey, e.overlayIv = n.options_.playerOptions.overlayIv),
            n.hasStarted(!1),
            this.getInfo(e),
            n.duration(0),
            n.playbackRate(1),
            n.options_.appID = e.appID,
            n.options_.fileID = e.fileID,
            n.bigPlayButton && n.bigPlayButton.show(),
            n.options_.plugins.ContinuePlay && n.ContinuePlay().init()
        },
        n.prototype.setPlayList = function(t) {
    ...
    Bi.registerComponent("MediaAsyncLoader", ra);
    var oa = (ce.getComponent("Component"), ce.getComponent("ClickableComponent")),
    sa = ["left-top", "left-bottom", "right-top", "right-bottom"],
    aa = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return n.on("logochange", ce.bind(r,
            function(t) {
                this.update(t.data)
            })),
            i.img && r.update(i),
        ...
        e.prototype.update = function(t) {
            ...
            this.setImg(e),
            this.setHref(n),
            this.options_ = ce.mergeOptions(this.options_, t),
            this.show()
        },
        e.prototype.setImg = function(t) {
            if (this.imgEl_) {
                this.imgEl_.src = t.url;
                var e = sa[t.position] || t.position || "left-top";
                ce.dom.addClass(this.el_, e)
            }
        },
    ...
    ce.registerComponent("LogoImage", aa);
    var la = ce.getComponent("Component"),
    ca = ce.getComponent("Button"),
    ua = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    ce.registerComponent("ContinuePlayTips", ua);
    var ha = function(t) {
        function e(n, i) {
            return Zn(this, e),
            ei(this, t.call(this, n, i))
        ...
        return ti(e, t),
        e.prototype.createEl = function() {
            var t = ce.dom.createEl("span", {
                className: "tcp-continue-play-tips-content"
            }),
            e = ce.dom.createEl("span", {
                className: "tcp-text",
                textContent: this.localize(this.options_.text || "Last time play at ")
            }),
            n = ce.dom.createEl("span", {
                className: "tcp-time",
                textContent: ce.formatTime(this.options_.time)
            });
    ...
    ce.registerComponent("ContinuePlayTipsContent", ha);
    var pa = function(t) {
        function e(n, i) {
            return Zn(this, e),
            ei(this, t.call(this, n, i))
    ...
    ce.registerComponent("ContinuePlayButton", pa);
    var da = ce.getComponent("Component"),
    fa = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            ...
            r.levelSwitch = n.options_.plugins.ContextMenu.levelSwitch,
            r.init(),
            n.on("playing", ce.bind(r,
            function() {
                r.playing = !0
            })),
            n.on("resolutionswitching", ce.bind(r,
            function(t) {
                r.switchHandler(r.createSwitching(t.data.label), 2e3)
            })),
            n.on("resolutionswitched", ce.bind(r,
            function() {
                r.switchHandler(r.createSwitched(), 2e3)
            })),
            n.on("levelSwitchError", ce.bind(r,
            function() {
        ...
        e.prototype.createEl = function() {
            ...
            return this.textNode = ce.dom.createEl("div", {
                innerText: ""
            }),
        ...
        e.prototype.init = function() {
            var t = this.addChild("closeButton", {
                controlText: "Close"
            });
            this.on(t, "close", this.hide)
        },
        e.prototype.createSwitching = function(t) {
            return this.levelSwitch.switchingText ? this.levelSwitch.switchingText + t: "正在为您切换至" + t
        },
        e.prototype.createSwitched = function() {
            return this.levelSwitch.switchedText ? this.levelSwitch.switchedText: "切换成功"
        },
        e.prototype.createSwitchError = function() {
            return this.levelSwitch.switchErrorText ? this.levelSwitch.switchErrorText: "切换失败"
        },
    ...
    ce.registerComponent("LevelSwitchTips", fa);
    var ya = ce.getComponent("Component"),
    ga = {
        fileID: "file ID",
    ...
    va = function(t) {
        ...
        e.prototype.createEl = function() {
            ...
            e = ce.dom.createEl("span", {
                ...
                innerText: ga[this.options_.key] + ":"
            }),
            n = ce.dom.createEl("span", {
        ...
        e.prototype.updateTextNode_ = function() {
            for (var t = this.el_.lastChild; t.firstChild;) t.removeChild(t.firstChild);
            this.displayData && this.show(),
            this.textNode_ = sn.createTextNode(this.displayData || ""),
            t.appendChild(this.textNode_)
        },
        e.prototype.updateContent = function(t) {
            t !== this.displayData && (this.displayData = t, this.requestAnimationFrame(this.updateTextNode_))
        },
    ...
    ce.registerComponent("VideoTextItem", va);
    var ma = {
    ...
    _a = function() {
        function e(n, i, r) {
            Zn(this, e);
            var o = new t(ce.mergeOptions(ma, r.hlsConfig)),
            s = i.el();
            this.Hls = t,
            this.tech = i,
            this.hls = o,
            ...
            o.on(t.Events.MANIFEST_PARSED, ce.bind(this, this.onMetaData)),
            o.on(t.Events.LEVEL_LOADED, this.onLevelLoaded.bind(this));
            for (var a in t.Events) o.on(t.Events[a], ce.bind(this, this.onEvent));
            o.attachMedia(s),
            o.loadSource(n.src)
        }
        ...
        e.prototype.onMetaData = function(t, e) {
            ...
            if (e.levels.length > 1) {
                var o = {
                    id: -1,
                    label: "auto",
                    selected: -1 === i.manualLevel
                };
                n.push(o),
                e.levels.forEach(function(t, e) {
                    var o = {};
                    o.id = e,
                    o.selected = e === i.manualLevel,
                ...
                var s = {
                    ...
                    callbacks: {
                        video: ce.bind(this, this.switchQuality)
                    }
                };
        ...
        e.prototype.onError = function(e, n) {
            ...
            case t.ErrorTypes.MEDIA_ERROR:
                this.hls.config.enableRecoverMediaError ? this.hlsjsErrorHandler(n) : i.error({
                    code: 15,
                    source: n
                });
                break;
        ...
        e.prototype.errorHandlerFactory = function() {
            ...
            return function(o) {
                var s = Date.now();
                r == t.config.recoverMediaErrorMaxRetry ? e.error({
                    code: 15,
                    source: o
                }) : (!n || s - n > 2e3 ? (n = s, t.recoverMediaError()) : (!i || s - i > 2e3) && (i = s, t.swapAudioCodec(), t.recoverMediaError()), r++)
            }
        },
        e.prototype.duration = function() {
    ...
    ba = /^application\/(x-mpegURL|vnd\.apple\.mpegURL)$/i,
    Ta = /\.m3u8/i,
    Ca = {
        name: "hlsSourceHandler",
        canHandleSource: function(t) {
            return t.skipHlsJs || t.keySystems && t.keySystems["com.apple.fps.1_0"] ? "": ba.test(t.type) ? "probably": Ta.test(t.src) ? "maybe": ""
        },
        handleSource: function(t, e, n) {
            return e.hlsProvider ? (e.hlsProvider.dispose(), e.hlsProvider = null) : n.hlsConfig && !1 === n.hlsConfig.autoStartLoad && e.on("play",
            function() {
                this.player().hasStarted() || this.hlsProvider.hls.startLoad()
            }),
            e.hlsProvider = new _a(t, e, n),
            e.hlsProvider
        },
        canPlayType: function(t) {
            return ba.test(t) ? "probably": ""
        }
    };
    Ge.mountHlsProvider = Me,
    Me();
    var Ea = function() {
        function t(n, i, r) {
            var o = this;
            if (Zn(this, t), r = r || i.options_, this.player = ce(r.playerId), this.player.dash = this.player.dash || {},
            this.tech_ = i, this.el_ = i.el(), this.elParent_ = this.el_.parentNode, this.hasFiniteDuration_ = !1, n.src) {
                i.isReady_ = !1,
                t.updateSourceData && (ce.log.warn('updateSourceData has been deprecated. Please switch to using hook("updatesource", callback).'), n = t.updateSourceData(n)),
                t.hooks("updatesource").forEach(function(t) {
                    n = t(n)
                });
                var s = n.src;
                this.keySystemOptions_ = t.buildDashJSProtData(n.keySystemOptions || n.keySystems),
                this.player.dash.mediaPlayer = e.MediaPlayer().create(),
                this.mediaPlayer_ = this.player.dash.mediaPlayer,
                t.useVideoJSDebug && (ce.log.warn('useVideoJSDebug has been deprecated. Please switch to using hook("beforeinitialize", callback).'), t.useVideoJSDebug(this.mediaPlayer_)),
                t.beforeInitialize && (ce.log.warn('beforeInitialize has been deprecated. Please switch to using hook("beforeinitialize", callback).'), t.beforeInitialize(this.player, this.mediaPlayer_)),
                ...
                this.mediaPlayer_.on(e.MediaPlayer.events.ERROR, this.retriggerError_),
                ...
                this.mediaPlayer_.on(e.MediaPlayer.events.MANIFEST_LOADED, this.getDuration_),
                this.mediaPlayer_.on(e.MediaPlayer.events.STREAM_INITIALIZED, ce.bind(this, this.onMetaData)),
                this.currentQuality = {
                    video: "",
                    audio: ""
                },
                Object.keys(e.MediaPlayer.events).forEach(function(t) {
                    o.mediaPlayer_.on(e.MediaPlayer.events[t], ce.bind(o, o.onEvent))
                }),
                r.dashConfig && Object.keys(r.dashConfig).forEach(function(t) {
                    var e, n = "set" + t.charAt(0).toUpperCase() + t.slice(1),
                    i = r.dashConfig[t];
                    if (o.mediaPlayer_.hasOwnProperty(n) && (ce.log.warn("Using dash options in videojs-contrib-dash without the set prefix has been deprecated. Change '" + t + "' to '" + n + "'"), t = n), !o.mediaPlayer_.hasOwnProperty(t)) return void ce.log.warn("Warning: dash configuration option unrecognized: " + t);
                    Array.isArray(i) || (i = [i]),
                    (e = o.mediaPlayer_)[t].apply(e, i)
                }),
                this.mediaPlayer_.attachView(this.el_),
                this.mediaPlayer_.setAutoPlay(!1),
                Ae.call(null, this.player, i),
                Le.call(null, this.player, i, r),
        ...
        t.prototype.dispose = function() {
            var t = this;
            this.mediaPlayer_ && (this.mediaPlayer_.off(e.MediaPlayer.events.ERROR, this.retriggerError_), this.mediaPlayer_.off(e.MediaPlayer.events.MANIFEST_LOADED, this.getDuration_), Object.keys(e.MediaPlayer.events).forEach(function(n) {
                t.mediaPlayer_.off(e.MediaPlayer.events[n], ce.bind(t, t.onEvent))
        ...
        t.removeHook = function(e, n) {
            var i = t.hooks(e).indexOf(n);
            return - 1 !== i && (t.hooks_[e] = t.hooks_[e].slice(), t.hooks_[e].splice(i, 1), !0)
        },
        t.prototype.onMetaData = function(t) {
            var e = this,
            n = this.mediaPlayer_,
            i = n.getBitrateInfoListFor("video"),
            r = [];
            if (i.length > 0) {
                r.push({
                    id: -1,
                ...
                i.forEach(function(t, i) {
                    r.push({
                        ...
                        selected: !n.getAutoSwitchQualityFor("video") && e.currentQuality.video === i
                    })
                });
                var o = {
                    qualityData: {
    ...
    var wa = function(t) {
        ...
        Ea.updateSourceData && (ce.log.warn('updateSourceData has been deprecated. Please switch to using hook("updatesource", callback).'), t = Ea.updateSourceData(t)),
        Ea.hooks("updatesource").forEach(function(e) {
            t = e(t)
        });
        var e = sn.createElement("video");
        return ! (t.keySystemOptions && !tn.navigator.requestMediaKeySystemAccess && !e.msSetMediaKeys)
    };
    ce.DashSourceHandler = function() {
        return {
            name: "dashSourceHandler",
            canHandleSource: function(t) {
                var e = /\.mpd/i;
                return wa(t) ? ce.DashSourceHandler.canPlayType(t.type) ? "probably": e.test(t.src) ? "maybe": "": ""
            },
            handleSource: function(t, e, n) {
                return new Ea(t, e, n)
            },
            canPlayType: function(t) {
                return ce.DashSourceHandler.canPlayType(t)
            }
        }
    },
    ce.DashSourceHandler.canPlayType = function(t) {
        return /^application\/dash\+xml/i.test(t) ? "probably": ""
    },
    Ge.mountDashProvider = Ne,
    Ne(),
    ce.Html5DashJS = Ea;
    var ka = ce.getComponent("Component"),
    Sa = ["fileID", "requestID", "mediaType", "mimeType", "provider", "resolution", "rate", "frames", "buffer", "connectionSpeed"],
    Ia = ["fileID", "requestID", "mediaType", "mimeType", "resolution", "rate", "buffer"],
    Pa = ["info"],
    xa = function(t) {
        function e(n, i) {
            Zn(this, e);
        ...
        e.prototype.tick = function() {
            var t = this;
            this.timeoutID = setTimeout(ce.bind(this,
            function() {
                t.tick()
            }), 1e3),
            this.updatePanel()
        ...
        e.prototype.updatePanel = function() {
            var t = this;
            if ("Html5" === this.player().techName_) switch (this.getStatus(), this.status.mediaType) {
            case "m3u8":
            ...
            } else "Flash" === this.player().techName_ && (this.getFlashStatus(), Pa.forEach(function(e) {
        ...
        e.prototype.getStatus = function() {
            ...
            this.getProvider(),
            this.getBuffer(),
            "m3u8" === this.status.mediaType && (this.getFrames(), this.getConnectionSpeed())
        },
        ...
        e.prototype.getBuffer = function() {
            ...
            n = (t / e * 100).toFixed(1) + "%",
            i = t + " / " + e + " (" + n + ")";
            return this.status.buffer = i,
            i
        },
        e.prototype.getSupport = function() {
            var t = void 0;
            return t = "m3u8" !== this.status.mediaType && "mp4" !== this.status.mediaType ? "视频统计功能不支持当前视频格式": "",
            this.status.info = t,
            t
        },
        e.prototype.getProvider = function() {
            var t = this.player_.tech_.sourceHandler_;
            return t instanceof _a ? (this.status.provider = "HlsJS", "HlsJS") : t instanceof Ea ? (this.status.provider = "DashJS", "DashJS") : ""
        },
        e.prototype.getFrames = function() {
            var t = this.player_.getVideoPlaybackQuality(),
            e = (t.droppedVideoFrames || 0) + " dropped of " + (t.totalVideoFrames || 0);
            return this.status.frames = e,
            e
        },
        e.prototype.getConnectionSpeed = function() {
            var t = this.player_.tech_.hlsProvider.hls.abrController._bwEstimator,
            e = void 0;
            return e = t && t.getEstimate() ? (125e-6 * t.getEstimate()).toFixed(0) + "KB/s": "0KB/s",
            this.status.connectionSpeed = e,
            e
        },
        e
    } (ka);
    ce.registerComponent("VideoStatisticWrapper", xa);
    var Da = ce.getComponent("Component"),
    Ma = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return n.on("statistic", ce.bind(r,
            function(t) {
        ...
        e.prototype.createEl = function() {
            var t = this,
            e = ce.dom.createEl("div", {
                className: "tcp-statistic vjs-hidden"
            }),
            n = ce.dom.createEl("div", {
    ...
    ce.registerComponent("VideoStatisticPanel", Ma);
    var Ra = ce.getComponent("MenuItem"),
    Aa = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return r.addClass("tc-menu-list"),
            r.open = !1,
            r.hasOpen = !1,
            r.player = n,
            r.setup(),
        ...
        e.prototype.setup = function() {
            ...
            function() {
                ...
                t.open ? (ce.dom.removeClass(e, "tcp-mirror"), ce.dom.removeClass(t.el_, "tcp-menu-item-select")) : (ce.dom.addClass(e, "tcp-mirror"), ce.dom.addClass(t.el_, "tcp-menu-item-select"), t.hasOpen = !0),
                t.open = !t.open
            })
        },
        e
    } (Ra);
    ce.registerComponent("MirrorMenuItem", Aa);
    var Oa = ce.getComponent("MenuItem"),
    ja = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    ce.registerComponent("PoweredByMenuItem", ja);
    var La = ce.getComponent("MenuItem"),
    Na = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            ...
            n.on("statistic", ce.bind(r,
            function(t) {
                "close" === t.data.action && (ce.dom.removeClass(r.el_, "tcp-menu-item-select"), r.hasOpen = !1)
            })),
            r.setup(),
            r
        }
        ...
        e.prototype.setup = function() {
            ...
            this.on(["tap", "click"],
            function() {
                t.hasOpen ? (ce.dom.removeClass(t.el_, "tcp-menu-item-select"), t.player.trigger({
                    type: "statistic",
                    data: {
                        action: "close"
                    }
                }), t.hasOpen = !1) : (ce.dom.addClass(t.el_, "tcp-menu-item-select"), t.player.trigger({
                    type: "statistic",
                    data: {
                        action: "open"
                    }
                }), t.hasOpen = !0, window.MtaH5 && MtaH5.clickStat("mirror", {
                    appid: t.player.options_.appID,
                    fileid: t.player.options_.fileID
                }), t.player.trigger({
                    type: "feature",
    ...
    ce.registerComponent("StatusMenuItem", Na);
    var Ba = (ce.getComponent("Component"), ce.getComponent("Menu")),
    Fa = (ce.getComponent("MenuItem"),
    function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            ...
            !i.statistic || dn || yn || r.addChild("StatusMenuItem", {
                label: "Video statistic"
            }),
            i.mirror && r.addChild("MirrorMenuItem", {
                label: "Mirror"
            }),
            n.on("contextmenu", ce.bind(r, r.onContextmenu)),
            n.on(["tap", "click"], ce.bind(r,
            function(t) {
            ...
            ce.on(document, ["tap", "click"], ce.bind(r,
            function(t) {
                this.popped && this.hide()
            }));
            var o = r;
            return r.children().forEach(function(t) {
                t.on(["tap", "click"],
                function() {
                    o.hide()
                })
        ...
        e.prototype.createEl = function() {
            var e = t.prototype.createEl.call(this);
            return ce.dom.addClass(e, "tcp-right-click-popup-menu"),
            e
        },
        e.prototype.show = function() {
            t.prototype.show.call(this),
        ...
        e.prototype.onContextmenu = function(t) {
            ...
            a = Math.max(0, a);
            var l = i + e.offsetHeight - s + 5;
            l = Math.max(0, l);
            var c = this.player().el().getBoundingClientRect();
            e.style.left = Math.max(0, n - c.left - a) + "px",
            e.style.top = Math.max(0, i - c.top - l) + "px"
        },
        e
    } (Ba));
    ce.registerComponent("RightClickPopupMenu", Fa);
    var Va = ce.getComponent("ClickableComponent"),
    Ha = ce.getComponent("TimeTooltip"),
    Ua = ce.getComponent("Component"),
    qa = ce.dom,
    za = ce.formatTime,
    Wa = {
    ...
    Qa = function(t) {
        ...
        e.prototype.registerListener = function() {
            this.player_.one("canplay", ce.bind(this, this.resetDotsElement))
        },
        ...
        e.prototype.dotHover = function() {
            ...
            i = n.getAttribute("class").search("tcp-without-gif") >= 0,
            r = n.el_.querySelector(".tcp-triangle-both") || n.el_.querySelector(".tcp-triangle");
            e > t ? i ? (n.el_.style.left = Wa.POPUP_CONTAINER_OFFSET_WITHOUTGIT + "px", r.style.left = Wa.TRIANGLE_OFFEST_WITHOUTGIF + "%") : (n.el_.style.left = Wa.POPUP_CONTAINER_OFFSET + "px", r.style.left = Wa.TRIANGLE_OFFEST + "%") : event.currentTarget.offsetLeft <= 140 && !i && (n.el_.style.left = Ka.POPUP_CONTAINER_OFFSET + "px", r.style.left = Ka.TRIANGLE_OFFEST + "px");
        ...
        e.prototype.setChildInTheContainer = function(t, e) {
            ...
            if ("" !== n) {
                var i = e.addChild("DotComment");
                i.el_.innerHTML = Pe(n)
            }
            if (t.img) {
                e.el_.querySelector(".tcp-triangle").setAttribute("class", "tcp-triangle-both");
                var r = e.addChild("DotImage");
                if (r.el_.firstChild.setAttribute("src", t.img), "" == n) e.addClass("tcp-only-gif"),
                r.el_.firstChild.className = "tcp-image-in-container-only-image";
                else {
                    this.countContentSize(n) <= 20 && (e.addClass("tcp-single-line"), i.el_.style.height = "23px")
                }
            } else if ("" !== n) {
                var o = this.countContentSize(n);
                o <= 14 ? e.addClass("tcp-single-line") : o <= 28 && e.addClass("tcp-two-lines"),
                e.addClass("tcp-without-gif"),
                i.addClass("tcp-large-comment")
            }
        },
        e.prototype.markSetUp = function(t) {
            ...
            if (! ("number" != typeof e || e > n)) {
                ...
                i.className = "tcp-dot-basic-style",
                i.setAttribute("dotinsecond", e.toString()),
                t["class"] && (i.className += " " + t["class"]);
                var r = this.addChild("PopUpContainer");
                return i.setAttribute("container-id", r.id_),
                this.setChildInTheContainer(t, r),
                i.appendChild(r.el_),
                i.style.left = e / n * 100 + "%",
                i.addEventListener("mouseover", ce.bind(this, this.dotHover)),
                i.addEventListener("mouseleave", ce.bind(this, this.dotMouseLeave)),
                i
            }
        },
        e.prototype.setUpEl = function() {
            ...
            i = this.el_ || t.prototype.createEl.call(this);
            return ce.dom.addClass(i, "tcp-dot-component"),
    ...
    ce.registerComponent("ProgressMarkerGenerator", Qa);
    var Xa = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return r.addClass("tcp-dot-comment"),
            r
        }
        return ti(e, t),
        e
    } (Ua);
    ce.registerComponent("DotComment", Xa);
    var $a = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    ce.registerComponent("DotImage", $a);
    var Ga = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            r.addClass("tcp-popup-container");
            var o = qa.createEl("div");
    ...
    ce.registerComponent("PopUpContainer", Ga);
    var Ya = ce.getComponent("Button"),
    Ja = ce.getComponent("BigPlayButton");
    Ja.prototype.createEl = function() {
        var t = Ya.prototype.createEl.call(this),
        e = Be();
        return (this.options_.shapeType || this.options_.styleType) && (e = Be(this.options_.shapeType, this.options_.styleType)),
        t.appendChild(ce.dom.createEl("div", {
            className: "vjs-button-icon",
            innerHTML: e
        })),
        t
    },
    Ja.prototype.controlText_ = "Play";
    var Za = ce.getComponent("Component");
    ce.getComponent("LoadingSpinner").prototype.createEl = function() {
        return Za.prototype.createEl.call(this, "div", {
            className: "tcp-loading-spinner",
            dir: "ltr"
        })
    };
    var tl = ce.getPlugin("plugin"),
    el = ce.log,
    nl = function(t) {
        function e(n, i) {
            Zn(this, e),
            el("Skin initializing");
            var r = ei(this, t.call(this, n));
            return r.player.addClass("tcp-skin"),
            el("Skin initialized"),
            r
        }
        return ti(e, t),
    ...
    ce.registerPlugin("Skin", nl);
    var il = ce.getPlugin("plugin"),
    rl = ce.log,
    ol = function(t) {
        function e(n, i) {
            Zn(this, e),
            rl("VID initializing");
            var r = ei(this, t.call(this, n));
            return r.init(r.player.options_),
            rl("VID initialized"),
            r
        }
        return ti(e, t),
        e.prototype.init = function(t) {
            var e = this.player,
            n = t.sources;
            t && t.appID && t.fileID || t.plugins.DRM && 0 == n.length ? t.children.splice(0, "mediaLoader" == t.children[0] ? 1 : 0, "mediaAsyncLoader") : (n.length > 0 || t.multiResolution && t.multiResolution.sources ? "mediaLoader" != t.children[0] && t.children.unshift("mediaLoader") : (rl("no video fileID or source"), "mediaLoader" != t.children[0] && t.children.unshift("mediaLoader")), e.ready(ce.bind(this,
            function() {
    ...
    ce.registerPlugin("VID", ol);
    var sl = Fe,
    al = "object" == typeof Je && Je && Je.Object === Object && Je,
    ll = al,
    cl = "object" == typeof self && self && self.Object === Object && self,
    ul = ll || cl || Function("return this")(),
    hl = ul,
    pl = function() {
        return hl.Date.now()
    },
    ...
    ml = gl.toString,
    _l = yl ? yl.toStringTag: undefined,
    bl = Ve,
    Tl = Object.prototype,
    Cl = Tl.toString,
    El = He,
    wl = "[object Null]",
    kl = "[object Undefined]",
    Sl = yl ? yl.toStringTag: undefined,
    Il = Ue,
    Pl = qe,
    xl = "[object Symbol]",
    Dl = ze,
    ...
    ql = Qe,
    zl = ce.getComponent("Component"),
    Wl = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return r.on("mousemove", r.handleMouseMove),
        ...
        e.prototype.handleMouseMove = function(t) {
            ...
            i = e.getChild("DvrMouseTimeDisplay");
            i && i.update(ce.dom.getBoundingClientRect(e.el()), n)
        },
        e.prototype.handleMouseUp = function(t) {
    ...
    ce.registerComponent("DvrProgressControl", Wl);
    var Kl = ce.getComponent("Slider"),
    Ql = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return r.percent_ = 1,
            r.update = ql(ce.bind(r, r.update), 50),
            r.on(n, "seekToLive", ce.bind(r,
            function(t) {
                this.update(t.data)
            })),
            r
        ...
        e.prototype.update = function(t) {
            t != undefined && (this.percent_ = t, this.bar.update(ce.dom.getBoundingClientRect(this.el_), t), this.updateAriaAttributes(t))
        },
        e.prototype.handleMouseDown = function(e) {
    ...
    ce.registerComponent("DvrSeekBar", Ql);
    var Xl = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
            return r.el_.style.width = "100%",
            r
        }
        return ti(e, t),
        e.prototype.createEl = function() {
    ...
    ce.registerComponent("DvrTimeShiftBar", Xl);
    var $l = ce.getComponent("MouseTimeDisplay"),
    Gl = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
        ...
        e.prototype.update = function(t, e) {
            ...
            this.rafId_ && this.cancelAnimationFrame(this.rafId_),
            this.rafId_ = this.requestAnimationFrame(function() {
                var i = n.player().Dvr().dvrData.maxTimeShift,
                r = ce.formatTime((1 - e) * i, i);
                n.el_.style.left = t.width * e + "px",
                n.getChild("timeTooltip").update(t, e, r)
            })
        },
    ...
    ce.registerComponent("DvrMouseTimeDisplay", Gl);
    var Yl = ce.getComponent("Button"),
    Jl = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
        ...
        return ti(e, t),
        e.prototype.createEl = function() {
            var t = Yl.prototype.createEl.call(this, "button", {
                className: "vjs-live-control vjs-control"
            });
            return this.contentEl_ = ce.dom.createEl("div", {
                className: "vjs-live-display",
    ...
    Jl.prototype.controlText_ = "返回直播",
    ce.registerComponent("LiveButton", Jl);
    var Zl = ce.getPlugin("plugin"),
    tc = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n));
            ...
            return n.ready(function() {
                ...
                if (e && e.Hls) {
                    var i = e.Hls;
                    t.one(i.Events.MANIFEST_LOADED,
                    function(t) {}),
                    t.one(i.Events.LEVEL_LOADED,
                    function(t) {}),
        ...
        e.prototype.init = function() {
            ...
            if (this.parseM3u8(e.manifests[0]), !this.dvrData.startTime && !this.isInit) return void t.one("loadedmetadata", ce.bind(this,
            function(t) {
                this.init()
            }));
            this.initControl(),
            this.delay = Te("delay", t.tech_.currentSource_.src) || 0,
            this.updateControl(!this.isLive()),
            t.on("loadedmetadata", ce.bind(this,
            function() {
        ...
        e.prototype.initControl = function() {
            ...
            t.controlBar.addChild("DvrProgressControl", {},
            5),
            t.controlBar.addChild("liveButton", {},
            6)
        },
        e.prototype.updateControl = function(t) {
            var e = this.player,
            n = e.controlBar.getChild("ProgressControl"),
            i = e.controlBar.getChild("LiveDisplay"),
            ...
            this.dvrData.startTime ? (r.show(), o.show(), n.hide(), i.hide()) : (r.hide(), o.hide(), n.show(), i.show())
        },
        ...
        e.prototype.timeShift = function(t) {
            ...
            i = Math.floor(this.dvrData.maxTimeShift * (1 - t));
            this.delay = i,
            0 == i && this.options.liveURL ? e.src(this.options.liveURL) : (n.src = (this.options.shiftURL || n.src).replace(/delay=*(\d+)/, "delay=" + i), e.src(e.tech_.currentSource_.src)),
            e.bigPlayButton.hide(),
            e.posterImage.hide(),
            e.tech_.one("hlsManifestParsed", ce.bind(this,
            function() {
                e.play()
            }))
        },
    ...
    ce.registerPlugin("Dvr", tc);
    var ec = ce.getComponent("Menu"),
    nc = function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
    ...
    rc = function(t) {
        ...
        e.prototype.updateItems = function() {
            for (var t = this.player().controlBar.getChild(this.options_.trackType + "QualitySwitcherMenuButton"), e = t.getChild(this.options_.trackType + "QualitySwitcherMenu"), n = e.children(), i = 0; i < n.length; i++) {
                var r = n[i];
                this !== r ? (r.selected(!1), r.options_.selected = !1) : r.options_.selected = !0
            }
        },
        e
    } (ic),
    oc = ce.getComponent("MenuButton"),
    sc = (ce.getComponent("Menu"),
    function(t) {
        function e() {
            return Zn(this, e),
            ei(this, t.apply(this, arguments))
        ...
        e.prototype.createEl = function() {
            var e = t.prototype.createEl.call(this);
            return this.labelEl_ = ce.dom.createEl("div", {
        ...
        e.prototype.createMenu = function() {
            for (var t = this.options_.qualityList,
            e = new nc(this.player(), {
                name: this.options_.trackType + "QualitySwitcherMenu"
            }), n = void 0, i = t.length - 1; i > -1; i--) {
                var r = t[i];
                n = ce.mergeOptions(r, {
                ...
                e.addItem(new rc(this.player(), n)),
    ...
    ac = ce.getPlugin("plugin"),
    lc = ["video", "audio", "subtitle"],
    cc = {
    ...
    hc = function(t) {
        function e(n, i) {
            ...
            var r = ei(this, t.call(this, n));
            return r.options = i,
            n.on("qualitydataloaded", ce.bind(r, r.init)),
            r
        }
        return ti(e, t),
        e.prototype.init = function(t) {
            uc("QualitySwitcher initializing", t);
            var e = this.player,
            ...
            if (this.setOptions({
                qualityData: n,
                callbacks: i
            }), !e.controlBar) return void uc("QualitySwitcher can not initialize without control bar");
            for (var r = 0; r < lc.length; r++) {
                var o = lc[r],
                s = o + "QualitySwitcherMenuButton",
                a = e.controlBar.getChild(s);
                n[o] && n[o].length > 0 && e.controlBar.options_.QualitySwitcherMenuButton && (a && a.el() && (a.dispose(), e.controlBar.removeChild(a)), this.repleaceLabel(o, n), a = new sc(e, {
                    name: s,
                    qualityList: n[o],
                    callback: i[o],
                    trackType: o
                }), a.addClass(cc[o]), e.controlBar.addChild(a, {},
                10))
            }
            uc("QualitySwitcher initialized", t, this)
        },
        e.prototype.setOptions = function(t) {
            this.options = ce.mergeOptions(this.options, t)
        },
        e.prototype.setVideoQuality = function(t) {
            if (this.options.qualityData && this.options.callbacks.video) {
                for (var e = this.options.qualityData.video,
                n = 0; n < e.length; n++) e[n].selected && (e[n].selected = !1),
                e[n].id === t.id && (e[n].selected = !0);
        ...
        e.prototype.repleaceLabel = function(t, e) {
            if (this.options.qualityLabelList) {
                var n = this.options.qualityLabelList[t],
                i = e[t];
                if (i && i.length > 0 && n && n.length > 0) for (var r = 0; r < i.length; r++) {
                    var o = i[r].label;
                    o = o.slice(0, o.length - 1);
                    for (var s = 0; s < n.length; s++) if (n[s].height == o) {
                        i[r].label = n[s].resolutionName;
                        break
                    }
                }
            }
        ...
        e.prototype.reset = function() {
            ...
            e = 0; e < lc.length; e++) {
                var n = lc[e],
                i = t.controlBar && t.controlBar.getChild(n + "QualitySwitcherMenuButton");
                i && i.el() && (i.dispose(), t.controlBar.removeChild(i))
            }
        },
        e
    } (ac);
    ce.registerPlugin("QualitySwitcher", hc);
    var pc = ce.getPlugin("plugin"),
    dc = ce.log,
    fc = {
        labels: {
            FLU: "流畅",
    ...
    yc = function(t) {
        function e(n, i) {
            ...
            var r = ei(this, t.call(this, n));
            return r.options = i,
            i.useManualOption && (r.manualOptions = st({},
            i)),
            r.hasInit = !1,
            n.on("multiresolutionchange", ce.bind(r,
            function(t) {
                t.data && this.update(data)
            })),
            n.on(["resolutionswitching", "resolutionswitched"], ce.bind(r,
            function(t) {
            ...
            function() {
                var t = n.tech(!0);
                t && (t.on("masterplaylistchange", ce.bind(this, this.onMasterPlaylistChange)), t.on("hlsresolutionswitching", ce.bind(this, this.onHlsLevelChange)), t.on("hlsresolutionswitched", ce.bind(this, this.onHlsLevelChange)), t.on("dashqualityswitching", ce.bind(this, this.onDashQualityChange)), t.on("dashqualityswitched", ce.bind(this, this.onDashQualityChange))),
                this.hasInit = !0
            })),
        ...
        e.prototype.init = function(t) {
            var e = this.player,
            n = st({},
            fc, t, this.manualOptions),
            i = n && n.sources;
            if (this.options = n, i) {
                dc("MultiResolution initializing", n);
                var r = void 0;
                if (this.currentID = n.defaultRes = i[n.defaultRes] ? n.defaultRes: Object.keys(i).shift(), r = i[this.currentID], "mediaLoader" != e.options_.children[0] || this.hasInit) e.src(r);
                else {
                    var o; (o = e.options_.sources).push.apply(o, r)
                }
                this.hasInit || (this.hasInit = !0),
                e.ready(ce.bind(this,
                function() {
                    e.trigger({
                ...
                dc("MultiResolution initialized")
            }
        },
        e.prototype.reset = function() {
        ...
        e.prototype.store = function(t) {
            ...
            this.options = ce.mergeOptions(fc, this.options, t)
        },
        ...
        e.prototype.switchResolution = function(t) {
            if (this.currentID != t.id) {
                ...
                s = ce.browser.IS_IOS || ce.browser.IS_ANDROID ? "loadeddata": "loadedmetadata";
                e.trigger({
                    type: "resolutionswitching",
                    data: t
                }),
                ...
                function() {
                    ...
                    i || e.currentTime(n),
                    "Flash" == e.techName_ ? (e.play(), e.tech(!0).trigger("seeked")) : (e.play(), e.playbackRate() != r && e.playbackRate(r)),
                    e.trigger({
                        type: "resolutionswitched",
                        data: t
                    })
                ...
                "none" == e.options_.preload && e.one("suspend",
                function() {
                    e.load()
                })
            }
        ...
        e.prototype.initQualityData = function(t) {
            ...
            i = t.showOrder;
            return i.length > 0 && i.forEach(function(i, r) {
                var o = {};
                o.id = i,
                o.selected = t.defaultRes === i,
                o.label = n[i] || i,
                e.push(o)
            }),
            {
                ...
                callbacks: {
                    video: ce.bind(this, this.switchResolution)
                }
            }
        },
    ...
    ce.registerPlugin("MultiResolution", yc);
    var gc = (ce.getComponent("Flash"), !ce.browser.IS_IPHONE),
    vc = ce.registerPlugin || ce.plugin,
    mc = {
        header: "",
        code: "",
        message: "",
    ...
    _c = function Lh(t, e) {
        ...
        r = void 0,
        o = [];
        ce.getComponent("ErrorDisplay").prototype.options_.fillAlways = !1;
        var s = function(t) {
            e.errors = ce.mergeOptions(e.errors, t),
        ...
        var a = function() {
            ...
            i = t.setTimeout(function() {
                t.error() || t.paused() || t.ended() || (r = !0, t.addClass("vjs-waiting"))
            },
            1e3),
            t.clearTimeout(n),
        ...
        h = function(n) {
            var i = "",
            r = t.error(),
            o = sn.createElement("div"),
            s = "";
            if (r) {
                r = ce.mergeOptions(r, e.errors[r.code || 0]),
                r.message && (i = '<div class="vjs-errors-message">' + t.localize(r.message) + "</div>"),
                r.code && (i += '<div class="vjs-errors-code">' + this.localize("Error Code") + " : " + r.code + "</div>"),
                r.type && (i += '<div class="vjs-errors-type">' + this.localize("Error Type") + " : " + r.type + "</div>"),
                "10" != r.code && "11" != r.code || (i += '<a href="https://ping.huatuo.qq.com/playvideo.qcloud.com" target="_blank" class="vjs-error-check-network">诊断网络</a>'),
                o.className = "vjs-errors-dialog",
                s = '<div class="vjs-errors-content-container">\n        ' + i + "\n      </div>";
                var a = t.getChild("errorDisplay");
                a.closeable(!("dismiss" in r) || r.dismiss) ? (o.innerHTML = s, a.fillWith(o), a.contentEl().firstChild.appendChild(a.getChild("closeButton").el())) : (o.innerHTML = s, a.fillWith(o)),
                a.one("modalclose",
                function() {
                    return t.error(null)
                })
        ...
        d = function(e) {
            p(),
            Lh(t, ce.mergeOptions(mc, e))
        };
        d.extend = function(t) {
            return s(t)
        },
        d.getAll = function() {
            return ce.mergeOptions(e.errors)
        },
    ...
    bc = function(t) {
        _c(this, ce.mergeOptions(mc, t))
    }; ["extend", "getAll", "disableProgress"].forEach(function(t) {
        bc[t] = function() {
            ce.log.warn("The errors." + t + "() method is not available until the plugin has been initialized!")
        }
    }),
    vc("Errors", bc);
    var Tc = ce.getPlugin("plugin"),
    Cc = {},
    Ec = ce.log,
    wc = function(t) {
        function e(n, i) {
            Zn(this, e),
            Ec("Reporter initilaizing");
            var r = ei(this, t.call(this, n));
            return r.initPlayCgiCodeReport(),
            r.mtaReportCache = [],
            Se(Ce("//pingjs.qq.com/h5/stats.js?v2.0.4"), null, {
                name: "MTAH5",
                sid: "500608092",
                cid: "500608093"
            },
            !0),
            Ec("Reporter initilaized"),
            r
        }
        return ti(e, t),
        e.prototype.initPlayCgiCodeReport = function() {
            var t = this.player;
            t.on("playcgistart", ce.bind(this, this.onPlayCgiStart)),
            t.on("playcgiend", ce.bind(this, this.onPlayCgiEnd))
        },
        e.prototype.onPlayCgiStart = function(t) {
            Cc[t.data.time] = Cc[t.data.time] || {},
            Cc[t.data.time].startTime = t.data.time,
            Cc[t.data.time].url = t.data.url
        },
        e.prototype.onPlayCgiEnd = function(t) {
            if (Cc[t.data.startTime]) {
                var e = t.data,
                n = void 0,
                i = void 0,
                r = void 0;
                if (e.error) switch (i = 2, e.error.message) {
                case "Timeout":
                    n = 10;
                    break;
                case "ServerError":
                    n = 11
                } else 0 == e.result.code ? (i = 1, n = 0) : (i = 3, n = e.result.code),
                r = e.result.requestId;
                this.reportPlayCgiToISD("", "", i, n, t.data.time - Cc[t.data.startTime].startTime, r, void 0, void 0)
            }
        },
        e.prototype.reportPlayCgiToISD = function(t, e, n, i, r, o, s, a) {
            var l = {
                ...
                time: r,
                appid: 20370,
                platform: ce.browser.IS_IOS ? "ios": ce.browser.IS_ANDROID ? "android": "pc",
                expansion1: o,
                expansion2: s,
                expansion3: a
            };
            this.sender(Ce("//report.huatuo.qq.com/code.cgi") + "?" + Ie(l))
        },
        ...
        function(e, n) {
            var i = {
                ...
                Store: function(t, e, n) {
                    var r = i.inherit(i.storeAPI,
                    function(t, e, n) {
                        return 0 === arguments.length ? r.getAll() : "function" == typeof e ? r.transact(t, e, n) : e !== undefined ? r.set(t, e, n) : "string" == typeof t || "number" == typeof t ? r.get(t) : "function" == typeof t ? r.each(t) : t ? r.setAll(t, e) : r.clear()
                    });
                    r._id = t;
                    try {
                    ...
                    return r._area || (r._area = i.storage("fake")),
                    r._ns = n || "",
                    i.areas[t] || (i.areas[t] = r._area),
                ...
                storeAPI: {
                    area: function(t, e) {
                        var n = this[t];
                        return n && n.area || (n = i.Store(t, e, this._ns), this[t] || (this[t] = n)),
                        n
                    },
                    namespace: function(t, e) {
                        ...
                        var n = t,
                        r = this[n];
                        if (! (r && r.namespace || (r = i.Store(this._id, this._area, this._ns + n + "."), this[n] || (this[n] = r), e))) for (var o in i.areas) r.area(o, i.areas[o]);
                        return r
                    },
                    isFake: function() {
                    ...
                    each: function(t, e) {
                        for (var n = 0,
                        r = i.length(this._area); n < r; n++) {
                            var o = this._out(i.key(this._area, n));
                            if (o !== undefined && !1 === t.call(this, o, this.get(o), e)) break;
                    ...
                    transact: function(t, e, n) {
                        var i = this.get(t, n),
                        r = e(i);
                        return this.set(t, r === undefined ? i: r),
                        this
                    },
                    set: function(t, e, n) {
                        var r = this.get(t);
                        return null != r && !1 === n ? e: i.set(this._area, this._in(t), i.stringify(e), n) || r
                    },
                    setAll: function(t, e) {
                        var n, i;
                        for (var r in t) i = t[r],
                        this.set(r, i, e) !== i && (n = !0);
                        return n
                    },
                    add: function(t, e) {
                        var n = this.get(t);
                        ...
                        return i.set(this._area, this._in(t), i.stringify(e)),
                        e
                    },
                    remove: function(t, e) {
                        var n = this.get(t, e);
                        return i.remove(this._area, this._in(t)),
                        n
                    },
                    clear: function() {
                    ...
                    _in: function(t) {
                        return "string" != typeof t && (t = i.stringify(t)),
            ...
            r.area("page", i.storage("page")),
            "function" == typeof n && n.amd !== undefined ? n("store2", [],
            function() {
                return r
            }) : t.exports ? t.exports = r: (e.store && (i.conflict = e.store), e.store = r)
        } (Je, Je && Je.define)
    }),
    Sc = ce.getPlugin("plugin"),
    Ic = ce.log,
    Pc = function(t) {
        function e(n, i) {
            Zn(this, e);
        ...
        e.prototype.onTimeUpdate = function(t) {
            kc.set(this.getStoreKey(), this.player.currentTime())
        },
        e.prototype.onPlay = function(t) {
            var e = this.player;
            Math.round(this.lastTime) > 1 && this.player.duration() > 1 && Math.round(this.lastTime) != Math.round(this.player.duration()) ? this.options.auto ? this.start() : e.addChild("ContinuePlayTips", ce.mergeOptions(this.options, {
                time: this.lastTime,
                resumeCallback: ce.bind(this, this.start)
            })) : "Flash" == e.techName_ && Math.round(this.lastTime) > 1 && Math.round(this.lastTime) != Math.round(this.player.duration()) && !this.player.duration() && e.one("loadedmetadata", ce.bind(this, this.onPlay))
        },
    ...
    ce.registerPlugin("ContinuePlay", Pc);
    var xc = {
        align: "top-left",
        className: "",
        content: "",
    ...
    Dc = ce.getComponent("Component"),
    Mc = ce.dom || ce,
    Rc = ce.registerPlugin || ce.plugin,
    Ac = function(t) {
    ...
    jc = function(t) {
        function e(n, i) {
            ...
            return ["start", "end"].forEach(function(t) {
                var e = r.options_[t];
                if (Ac(e)) r[t + "Event_"] = "timeupdate";
                else if (Oc(e)) r[t + "Event_"] = e;
            ...
            ["endListener_", "rewindListener_", "startListener_"].forEach(function(t) {
                r[t] = function(n) {
                    return e.prototype[t].call(r, n)
                }
            }),
            "timeupdate" === r.startEvent_ && r.on(n, "timeupdate", r.rewindListener_),
        ...
        e.prototype.createEl = function() {
            ...
            return "string" == typeof e ? i.innerHTML = e: ce.browser.IS_IE8 || e instanceof tn.DocumentFragment ? i.appendChild(e) : Mc.appendContent(i, e),
            i
        },
        e.prototype.debug = function() {
            if (this.options_.debug) {
                ...
                n = arguments.length,
                i = Array(n), r = 0; r < n; r++) i[r] = arguments[r];
                t.hasOwnProperty(i[0]) && "function" == typeof t[i[0]] && (e = t[i.shift()]),
                e.apply(undefined, ["overlay#" + this.id() + ": "].concat(i))
            }
        },
        e.prototype.hide = function() {
            ...
            this.options_.once ? (ce.browser.IS_IOS && ce.browser.IS_WECHAT ? this.player().hasStarted() || this.player().ready(ce.bind(this,
            function() {
                this.startListener_({
        ...
        e.prototype.shouldShow_ = function(t, e) {
            ...
            i = this.options_.end;
            return Ac(n) ? Ac(i) ? t >= n && t < i: this.hasShownSinceSeek_ ? Math.floor(t) === n: (this.hasShownSinceSeek_ = !0, t >= n) : n === e
        },
        ...
        e.prototype.rewindListener_ = function(t) {
            ...
            r = this.options_.end;
            e < n && (this.debug("rewind detected"), Ac(r) && !this.shouldShow_(e) ? (this.debug("hiding; " + r + " is an integer and overlay should not show at this time"), this.hasShownSinceSeek_ = !1, this.hide()) : Oc(r) && e < i && (this.debug("hiding; show point (" + i + ") is before now (" + e + ") and end point (" + r + ") is an event"), this.hasShownSinceSeek_ = !1, this.hide())),
            this.previousTime_ = e
        },
        e
    } (Dc);
    ce.registerComponent("Overlay", jc),
    Rc("Patch",
    function(t) {
        var e = this,
        n = ce.mergeOptions(xc, t);
        ...
        var i = n.overlays;
        delete n.overlays,
        this.overlays_ = i.map(function(t) {
            var i = ce.mergeOptions(n, t);
            return i.attachToControlBar && e.controlBar && -1 !== i.align.indexOf("bottom") ? e.controlBar.addChild("overlay", i) : e.addChild("overlay", i)
        })
    });
    var Lc = ce.getPlugin("plugin"),
    Nc = ce.log,
    Bc = ["start", "pause", "ended"],
    Fc = ["loadstart", "pause", "ended"],
    Vc = ["play", "play", "play"],
    Hc = function(t) {
        function e(n, i) {
            Zn(this, e);
        ...
        e.prototype.init = function(t) {
            ...
            Array.isArray(t) && t.length > 0 && (Nc("ImagePatch initializing"), t.forEach(function(t) {
                var n = void 0,
                r = void 0,
                o = void 0,
                s = void 0,
                ...
                t.url && (s = e.loadImg(Ce(t.url), ce.bind(e, e.onImgLoaded)), s.className = "tcp-overlay-img", o.appendChild(s), ce.browser.IS_IE8 ? (n = document.createElement("div"), n.className = "tcp-overlay-table", r = document.createElement("div"), r.className = "tcp-overlay-cell", r.appendChild(o), n.appendChild(r), a.appendChild(n)) : a.appendChild(o), i.overlays.push({
                    content: a,
                    className: "tcp-image-patch tcp-image-patch-" + Bc[t.location],
                    start: Fc[t.location],
                    end: Vc[t.location],
                    once: 0 == t.location,
                    align: "center"
                }))
            }), i.overlays.length > 0 ? (n.Patch(i), n.trigger({
                type: "feature",
                data: "patch"
            }), this.hasInit = !0) : this.reset(), Nc("ImagePatch initialized"))
        },
        e.prototype.loadImg = function(t, e) {
            var n, i, r, o, s, a = new Image;
            return a.src = t,
            a.complete ? (e && e.call(e, a), a) : (i = a.width, r = a.height, a.onerror = function() {
                n.end = !0,
            ...
            n = function() {
                o = a.width,
                s = a.height,
                (o !== i || s !== r || o * s > 1024) && (e && e.call(e, a), n.end = !0)
            },
            n(), a.onload = function() { ! n.end && n(),
                a = a.onload = a.onerror = null
            },
            a)
        },
        e.prototype.onImgLoaded = function(t) {
            if (ce.browser.IE_VERSION) {
                var e = parseInt(this.player.el().currentStyle.width),
                n = parseInt(this.player.el().currentStyle.height);
                if (t.width > e || t.height > n) {
                    var i = e / (t.width / t.height);
                    t.width / t.height > e / n || (t.style.marginTop = (n - i) / 2 + "px"),
                    t.style.width = "100%",
                    t.style.height = "auto"
                }
            }
        ...
        e.prototype.reset = function() {
            this.hasInit && (Nc("ImagePatch reset"), this.player.Patch(), this.hasInit = !1)
        },
        e
    } (Lc);
    ce.registerPlugin("ImagePatch", Hc);
    var Uc = ce.getPlugin("plugin"),
    qc = ce.log,
    zc = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n));
            return r.options = i,
            qc("ContextMenu initializing"),
            r.init(),
            qc("ContextMenu initialized"),
            r
        }
        return ti(e, t),
        e.prototype.init = function() {
    ...
    ce.registerPlugin("ContextMenu", zc);
    var Wc = ce.getPlugin("plugin"),
    Kc = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n));
        ...
        e.prototype.init = function() {
            ...
            e && e.levelSwitch && e.levelSwitch.open && t.addChild("LevelSwitchTips", this.options)
        },
        e
    } (Wc);
    ce.registerPlugin("LevelSwitch", Kc);
    var Qc = ce.getPlugin("plugin"),
    Xc = ce.log,
    $c = {
        width: 0,
        height: 0,
    ...
    Gc = function(t) {
        ...
        e.prototype.init = function(t) {
            if (!ce.browser.IS_IOS && !ce.browser.IS_ANDROID && this.player.controlBar && this.player.controlBar.progressControl) {
                if (Xc("VttThumbnail initializing", t), !this.player.controlBar) return void Xc("VttThumbnail can not initialize without control bar");
                this.options = t;
                var e = this.player,
                n = e.controlBar.progressControl;
                this.loadTrackFile(t),
                $c.basePath = tu(t.vttUrl),
                this.initUI(),
                n.on("mouseenter", ce.bind(this, this.onMouseEnter)),
                n.on("mousemove", ce.bind(this, this.onMouseMove)),
                n.on("mouseleave", ce.bind(this, this.onMouseOut)),
                this.hasInit = !0,
                Xc("VttThumbnail initialized"),
                e.trigger({
                    type: "feature",
                    data: "thumbnail"
                })
        ...
        e.prototype.onMouseMove = function(t) {
            ...
            p = void 0,
            d = void 0;
            for (i = this.player.controlBar.progressControl, r = this.player.controlBar.progressControl.seekBar, o = Jc(i.el()).getBoundingClientRect(), s = Jc(r.el()).getBoundingClientRect(), e = t.clientX, l = this.player.duration(), a = ((e - s.left) / r.width() * l).toFixed(3), u = this.trackInfo.track || this.trackInfo; c < u.cues.length;) {
        ...
        e.prototype.setView = function(t) {
            ...
            i.imgUrl && n.src != i.imgUrl ? n.src = i.imgUrl: n.src = t.src,
            n.style.left = -t.x + "px",
            n.style.top = -t.y + "px",
        ...
        e.prototype.reset = function() {
            if (this.hasInit) {
                Xc("VttThumbnail reset");
                var t = this.player,
                e = t.controlBar.progressControl;
                e.off("mousemove", ce.bind(this, this.onMouseMove)),
                e.off("mouseleave", ce.bind(this, this.onMouseOut)),
                this.hasInit = !1
            }
        },
        e
    ...
    Jc = function Nh(t) {
        return "HTML" !== t.nodeName && "static" === Yc(t)("position") ? Nh(t.offsetParent) : t
    },
    Zc = function(t) {
        var e = void 0,
        n = void 0,
        ...
        if (e = t.substring(0, n), /^(http:|https:|\/\/)/.test(e) || (e = $c.basePath + e), i = t.substring(n + 1), "xywh=" !== i.substring(0, 5)) return {
            src: e,
            w: 0,
            h: 0,
            x: 0,
    ...
    tu = function(t) { / ^(\ / \ / ) / .test(t) && (t = "https:" + t);
        var e = /(\w+):\/\/([^\:|\/]+)(\:\d*)?(.*\/)([^#|\?|\n]+)?(#.*)?(\?.*)?/i,
        n = t.match(e);
        if (n && n[2] && n[4]) return "//" + n[2] + n[4]
    };
    ce.registerPlugin("VttThumbnail", Gc);
    var eu = ce.getPlugin("plugin"),
    nu = ce.log,
    iu = function(t) {
        function e(n, i) {
            Zn(this, e),
            nu("PlayerMetrics initializing");
            var r = ei(this, t.call(this, n));
            return r.hasInit = !1,
            r.features = [],
            r.timing = {},
            ...
            r.registerListener(),
            n.ready(ce.bind(r, r.init)),
            nu("PlayerMetrics initialized"),
            r.getSystemVer(),
            r
        }
        return ti(e, t),
        ...
        e.prototype.registerListener = function() {
            ...
            function() {
                ...
                "Flash" == e.techName_ && (nu("use flash"), t.reportMTA("flash", {
            ...
            function() {
                if (!t.playStatus.isFirstPlay) {
                    ...
                    function() {
                        n.lagging || e.seeking() || n.skip || (n.lagging = !0, n.lagStart = ke())
                    }), e.currentSource().keySystems) {
                        var i = e.currentSource().keySystems;
                        i["com.widevine.alpha"] && (t.reportMTA("drm", {
                            success: "Widevine"
                        }), nu("DRM success Widevine")),
                        i["com.apple.fps.1_0"] && (t.reportMTA("drm", {
                            success: "FairPlay"
                        }), nu("DRM success FairPlay"))
                    } else e.options_.plugins.DRM && e.options_.plugins.DRM.token && (t.reportMTA("drm", {
                        success: "simpleAES"
                    }), nu("DRM success simpleAES"))
                }
                n.lagging && (n.lagEnd = ke()) - n.lagStart > n.lagInterval && (n.lagging = !1, n.lagCount++, n.lagDuration += n.lagEnd - n.lagStart, n.lagEnd = n.lagStart = 0, t.lagStatus.isFirstLag || (t.lagStatus.isFirstLag = !0, t.setTimingData({
                    firstLag: ke()
                }), t.report({
            ...
            e.on("error", ce.bind(this, this.onError)),
            e.on("resolutionswitching",
            function(t) {
                n.skip = !0
            }),
            e.on("resolutionswitched",
            function(t) {}),
            e.on("pause",
            function() {
                n.lagging && (n.skip = !0)
            ...
            function(n) {
                var i = n.data;
                i.result && 0 == i.result.code && (t.playStatus.requestID = i.result.requestId, setTimeout(function() {
            ...
            function() {
                var e = {
                    PlayTiming: ke() - t.timing.firstPlaying
                };
                t.lagStatus.lagCount > 1 && (e.stuckTime = t.lagStatus.lagDuration),
                t.report(e)
            }),
            e.on("feature",
            function(e) { - 1 == t.features.indexOf(e.data) && t.features.push(e.data)
            })
        },
        e.prototype.setTimingData = function(t) {
            this.timing = ce.mergeOptions(this.timing, t)
        },
        e.prototype.reset = function() {
            this.playStatus = {
                isFirstPlay: !1
        ...
        e.prototype.onError = function(t, e) {
            ...
            var n = gr(this.player.src());
            vn && n ? this.reportMTA("x5_err", {
                format: n
        ...
        e.prototype.report = function(t) {
            ...
            setTimeout(function() {
                var n = e.player;
                n.options_ && (t = ce.mergeOptions(t, {
                ...
                }), e.playStatus.requestID && (t.serialID = e.playStatus.requestID), n.Reporter().reportPlayMetrics(t))
            },
            1)
        },
        e.prototype.getSystem = function() {
            return dn ? "ios": yn ? "android": jn ? "win": Ln ? "mac": "other"
        },
        e.prototype.getSystemVer = function() {
            var t = this.getSystem();
            return "ios" == t ? fn: "android" == t ? gn: "win" == t ? Nn: "mac" == t ? Bn: void 0
        },
        e.prototype.getBrowser = function() {
            return kn ? "firefox": Sn ? "edge": _n ? "mqq": bn ? "qq": vn ? "tbs": In ? "chrome": Dn ? "ie": Mn ? "safari": "other"
        },
        e.prototype.getBrowserVer = function() {
            var t = this.getBrowser();
            return "firefox" == t ? Un: "edge" == t ? Vn: "chrome" == t ? "chrome" + Pn: "ie" == t ? "ie" + Dn: "safari" == t ? Hn: "qq" == t || "mqq" == t ? Fn: "tbs" == t ? mn: "other"
        },
        e.prototype.getDevice = function() {
            return dn ? "ios" + fn: qn ? "华为": zn ? "小米": Wn ? "oppo": Kn ? "vivo": Qn ? "三星": $n ? "酷派": Xn ? "一加": Gn ? "中兴": "其他"
        },
        e.prototype.getMediaType = function() {
    ...
    ce.registerPlugin("PlayerMetrics", iu);
    var ru = ce.getPlugin("plugin"),
    ou = ce.log,
    su = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n));
            return dn || yn || n.ready(ce.bind(r, r.init)),
            r
        }
        return ti(e, t),
        e.prototype.init = function() {
            var t = this.player;
            if (!t.controlBar || !this.player.controlBar.progressControl) return void ou("ProgressMarker can not initialize without control bar or progress control");
            ou("ProgressMarker initializing");
            ...
            t.options_.dots && t.options_.plugins.ProgressMarker && (e.addChild("ProgressMarkerGenerator"), ou("ProgressMarker initialized"), t.trigger({
                type: "feature",
                data: "marker"
            }))
        },
    ...
    ce.registerPlugin("ProgressMarker", su);
    var au = ce.getComponent("Component"),
    lu = function(t) {
        function e(n, i) {
            return Zn(this, e),
            ei(this, t.call(this, n, i))
    ...
    ce.registerComponent("PlayListItem", lu);
    var cu = ce.getComponent("Component"),
    uu = function(t) {
        function e(n, i) {
            return Zn(this, e),
            ei(this, t.call(this, n, i))
    ...
    ce.registerComponent("PlayListTitle", uu);
    var hu = ce.getComponent("Component"),
    pu = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
        ...
        e.prototype.init = function() {
            ...
            this.player_.on("playItem",
            function(n) {
                var i = n.data,
                r = void 0;
                t.activeIndex = i ? i.index: (t.activeIndex + 1) % e.length,
                r = e[t.activeIndex],
                t.player_.loadVideoByID({
                    fileID: r.fileID,
                    appID: r.appID
                }),
                t.player_.one("loadedmetadata", ce.bind(t,
                function() {
                    t.player_.play()
                })),
                document.querySelectorAll(".tcp-playlist-item").forEach(function(t) {
                    ce.dom.removeClass(t, "tcp-playlist-item-active")
                });
                var o = document.querySelectorAll(".tcp-playlist-item")[t.activeIndex];
                ce.dom.addClass(o, "tcp-playlist-item-active")
            })
        },
        e
    } (hu);
    ce.registerComponent("PlayListBox", pu);
    var du = ce.getComponent("Component"),
    fu = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
        ...
        e.prototype.bindEvent = function(t) {
            ...
            function(n) {
                e.status = !e.status;
                var i = document.querySelector(".tcp-playlist");
                e.status ? (t.textContent = ">", ce.dom.addClass(i, "tcp-playlist-open"), ce.dom.removeClass(i, "tcp-playlist-close")) : (ce.dom.addClass(i, "tcp-playlist-close"), ce.dom.removeClass(i, "tcp-playlist-open"), t.textContent = "<")
            })
        },
        e
    } (du);
    ce.registerComponent("PlayListToggle", fu);
    var yu = ce.getComponent("Component"),
    gu = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
    ...
    ce.registerComponent("PlayList", gu);
    var vu = ce.getComponent("Button"),
    mu = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n, i));
        ...
        e.prototype.addClass = function() {
            ce.dom.addClass(this.el_, "vjs-play-next")
        },
        e.prototype.update = function() {},
        e.prototype.handleClick = function(t) {
            this.player_.trigger({
    ...
    mu.prototype.controlText_ = "Play Next",
    ce.registerComponent("PlayNextButton", mu);
    var _u = ce.getPlugin("plugin"),
    bu = ce.log,
    Tu = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n));
            return dn || yn ? ei(r) : (r.options = i, i && i.data instanceof Array && i.data.length > 0 && n.ready(ce.bind(r, r.init)), r)
        }
        return ti(e, t),
        e.prototype.init = function() {
            bu("PlayList initializing"),
            this.player.addChild("PlayList", this.options),
            this.player.controlBar.addChild("PlayNextButton", {},
            1),
            bu("PlayList initialized"),
            this.player.trigger({
                type: "feature",
                data: "playlist"
            })
    ...
    ce.registerPlugin("PlayList", Tu);
    var Cu = ce.getPlugin("plugin"),
    Eu = ce.log,
    wu = function(t) {
        function e(n, i) {
            Zn(this, e);
            var r = ei(this, t.call(this, n));
            return Eu("HLSToken", n, i),
            r.init(i),
            r
        }
        return ti(e, t),
        e.prototype.init = function(t) {
            ...
            var e = this.player;
            t.token && (this.options = t, e.on("playcgiend", ce.bind(this,
            function(t) {
        ...
        e.prototype.modifyData = function(t) {
            ...
            if (Eu("HLSToken modifyData", t), 0 === t.result.code) {
                ...
                if (n.masterPlayList) {
                    var i = n.masterPlayList.url.split("/");
                    i[i.length - 1] = "voddrm.token." + this.options.token + "." + i[i.length - 1],
                    n.masterPlayList.url = i.join("/")
                }
    ...
    ce.registerPlugin("HLSToken", wu);
    var ku = function(t) {
        var e = (new tn.DOMParser).parseFromString(String.fromCharCode.apply(null, new Uint16Array(t)), "application/xml"),
        n = e.getElementsByTagName("HttpHeaders")[0],
        i = {};
        if (n) for (var r = n.getElementsByTagName("name"), o = n.getElementsByTagName("value"), s = 0; s < r.length; s++) i[r[s].childNodes[0].nodeValue] = o[s].childNodes[0].nodeValue;
        var a = e.getElementsByTagName("Challenge")[0],
        l = void 0;
        return a && (l = tn.atob(a.childNodes[0].nodeValue)),
        {
            headers: i,
            message: l
        }
    ...
    Iu = function(t) {
        ...
        return Object.keys(t).forEach(function(n) {
            var i = {},
            r = t[n].audioContentType,
            o = t[n].videoContentType;
            r && (i.audioCapabilities = [{
                contentType: r
            }]),
            o && (i.videoCapabilities = [{
                contentType: o
            }]),
            e = e ? e["catch"](function(t) {
                return tn.navigator.requestMediaKeySystemAccess(n, [i])
            }) : tn.navigator.requestMediaKeySystemAccess(n, [i])
        }),
        e
    },
    Pu = function(t) {
        ...
        function(t) {
            o(r, t.message).then(function(t) {
                return l.update(t)
            })["catch"](ce.log.error.bind(ce.log.error, "failed to get and set license"))
        },
        !1),
        l.addEventListener("keystatuseschange",
        function(t) {
            var e = !1;
            l.keyStatuses.forEach(function(n, i) {
                switch (a.trigger({
                    keyId: i,
                    status: n,
                    target: l,
                ...
                case "expired":
                    ...
                    break;
                case "internal-error":
                    ce.log.warn('Key status reported as "internal-error." Leaving the session open since we don\'t have enough details to know if this error is fatal.', t)
                }
            }),
        ...
        !1),
        l.generateRequest(n, i)["catch"](ce.log.error.bind(ce.log.error, "Unable to create or initialize key session"))
    },
    xu = function(t) {
        var e = t.video,
        n = t.initDataType,
    ...
    Ou = function(t, e) {
        ...
        return e.url && !e.getLicense && (e.getLicense = "com.microsoft.playready" === t ? Mu(e.url) : Ru(e.url)),
        e
    },
    ju = function(t) {
        var e = t.video,
        ...
        if ("undefined" == typeof e.mediaKeysObject) {
            ...
            var l = void 0,
            c = void 0;
            if (! (a = Iu(r.keySystems))) return ce.log.error("No supported key system found"),
            Promise.resolve();
            a = a.then(function(t) {
                return new Promise(function(n, i) {
                    if (e.keySystem = t.keySystem, c = Ou(t.keySystem, r.keySystems[t.keySystem]), !c.getCertificate) return void n(t);
                    c.getCertificate(r,
                    function(e, r) {
                ...
                return Du({
                    ...
                    createdMediaKeys: t,
                    options: r,
                    getLicense: Au(c.getLicense, s),
                    removeSession: o,
                    eventBus: s
                })
            })["catch"](ce.log.error.bind(ce.log.error, "Failed to create and initialize a MediaKeys object"))
        }
        return a.then(function() {
            xu({
                ...
                initData: i,
                options: r,
                getLicense: e.keySystem ? Au(Ou(e.keySystem, r.keySystems[e.keySystem]).getLicense, s) : null,
                removeSession: o,
                eventBus: s
            })
        })
    ...
    Lu = function(t) {
        for (var e = new ArrayBuffer(2 * t.length), n = new Uint16Array(e), i = 0; i < t.length; i++) n[i] = t.charCodeAt(i);
        return n
    },
    Nu = function(t) {
    ...
    Fu = function(t, e) {
        ...
        for (var n = new DataView(t), i = new DataView(e), r = 0; r < n.byteLength; r++) if (n.getUint8(r) !== i.getUint8(r)) return ! 1;
        return ! 0
    },
    Vu = function(t) {
    ...
    Hu = function(t) {
        ...
        n = t.id,
        i = t.cert;
        "string" == typeof n && (n = Lu(n));
        var r = 0,
        o = new ArrayBuffer(e.byteLength + 4 + n.byteLength + 4 + i.byteLength),
        s = new DataView(o);
        new Uint8Array(o, r, e.byteLength).set(e),
        r += e.byteLength,
        s.setUint32(r, n.byteLength, !0),
        r += 4;
        var a = new Uint16Array(o, r, n.length);
        return a.set(n),
        r += a.byteLength,
    ...
    Uu = function(t) {
        ...
        return new Promise(function(t, l) {
            if (e.webkitKeys || e.webkitSetMediaKeys(new tn.WebKitMediaKeys("com.apple.fps.1_0")), !e.webkitKeys) return void l("Could not create MediaKeys");
            var c = e.webkitKeys.createSession("video/mp4", Hu({
                id: n,
                initData: i,
                cert: r
            }));
            ...
            c.contentId = n,
            c.addEventListener("webkitkeymessage",
            function(t) {
                s(o, n, t,
                function(t, e) {
            ...
            c.addEventListener("webkitkeyadded",
            function(e) {
                t(e)
            }),
            c.addEventListener("webkitkeyerror",
            function(t) {
                l(t)
            })
        })
    ...
    Ku = function(t) {
        ...
        i = t.options,
        r = t.eventBus,
        o = i.keySystems["com.apple.fps.1_0"],
        s = o.getCertificate || qu(o.certificateUri),
        a = o.getContentId || zu,
        l = o.getLicense || Wu(o.licenseUri);
    ...
    Qu = function(t, e, n, i) {
        ...
        if ("function" == typeof r.getKey) return void r.getKey(t, n.destinationURL, n.message.buffer,
        function(t, n) {
            if (t) return void ce.log.error("Unable to get key: " + t);
            e.update(n)
        });
        "string" == typeof r && (r = {
            url: r
        });
        var o = r.url || n.destinationURL;
        Su(o, n.message.buffer,
        function(t, n) {
            if (i && i.trigger("licenserequestattempted"), t) return void ce.log.error("Unable to request key from url: " + o);
            e.update(new Uint8Array(n.body))
        })
    },
    Xu = function(t, e, n, i) {
        var r = t.msKeys.createSession("video/mp4", e);
        if (!r) return void ce.log.error("Could not create key session.");
        r.addEventListener("mskeymessage",
        function(t) {
            Qu(n, r, t, i)
        }),
        r.addEventListener("mskeyerror",
        function(t) {
            ce.log.error("Unexpected key error from key session with code: " + r.error.code + " and systemCode: " + r.error.systemCode)
        })
    },
    $u = function(t) {
        var e = t.video,
        ...
        try {
            e.msSetMediaKeys(new tn.MSMediaKeys("com.microsoft.playready"))
        } catch(o) {
            return void ce.log.error("Unable to create media keys for PlayReady key system. Error: " + o.message)
        }
        Xu(e, n, i, r)
    },
    Gu = ce.getPlugin("plugin"),
    Yu = function(t, e) {
        for (var n = 0; n < t.length; n++) if (t[n].initData) {
            var i = Vu(t[n].initData),
            r = Vu(e);
            if (Fu(i, r)) return ! 0
        }
        return ! 1
    ...
    Zu = function(t, e, n, i) {
        ...
        var r = t.initData;
        return Iu(e.keySystems).then(function(o) {
            var s = o.keySystem;
            if (e.keySystems[s] && e.keySystems[s].pssh && (r = e.keySystems[s].pssh), !Yu(n, r) && r) return n.push({
                initData: r
            }),
            ju({
                video: t.target,
    ...
    eh = function(t, e, n, i) {
        ...
        !1)) {
            var r = t.initData;
            e.keySystems["com.microsoft.playready"] && e.keySystems["com.microsoft.playready"].pssh && (r = e.keySystems["com.microsoft.playready"].pssh),
            r && (n.push({
                playready: !0,
                initData: r
            }), $u({
    ...
    nh = function(t) {
        return ce.mergeOptions(t.currentSource(), t.eme.options)
    },
    ih = function(t) {
        var e = t.src();
    ...
    rh = function(t) {
        "video" === t.$(".vjs-tech").tagName.toLowerCase() && t.tech_ && (ih(t), t.tech_.el_.addEventListener("encrypted",
        function(e) {
            ...
            ih(t),
            Zu(e, nh(t), t.eme.sessions, t.tech_)
        }), t.tech_.el_.addEventListener("webkitneedkey",
        function(e) {
            ih(t),
            th(e, nh(t), t.tech_)
        }), ce.browser.IS_EDGE || t.tech_.el_.addEventListener("msneedkey",
        function(e) {
            ih(t),
            eh(e, nh(t), t.eme.sessions, t.tech_)
        }))
    },
    oh = function(t) {
        function e(n, i) {
            ...
            n.eme = {
                initializeMediaKeys: function() {
                    ...
                    r = ce.mergeOptions(n.currentSource(), i, t),
                    o = {
                        initDataType: "cenc",
                        initData: null,
                        target: n.tech_.el_
                    ...
                    ih(n),
                    n.tech_.el_.setMediaKeys ? Zu(o, r, n.eme.sessions, n.tech_).then(function() {
                        return e()
                    })["catch"](function(t) {
                        return e(t)
                    }) : n.tech_.el_.msSetMediaKeys && (eh(o, r, n.eme.sessions, n.tech_), e())
                },
                options: i
            },
            r
        ...
        e
    } (Gu); (ce.registerPlugin || ce.plugin)("DRM", oh);
    var sh = ce.getPlugin("plugin"),
    ah = ce.dom;
    if (!window.requestAnimationFrame) {
        var lh = 0;
        window.requestAnimationFrame = function(t) {
            var e = (new Date).getTime(),
            n = Math.max(0, 16.7 - (e - lh)),
    ...
    var ch = function(t) {
        ...
        e.prototype.init = function() {
            ...
            function() {
                t.calculateStyle(),
                t.setStyle(),
                ah.removeClass(t.containerElement, "vjs-hidden")
            }),
            e.one("play",
            function() {
                t.startAnimation()
            }),
            e.on(["fullscreenchange", "playerresize"],
            function() {
                setTimeout(function() {
                    t.calculateStyle()
                },
        ...
        e.prototype.calculateStyle = function() {
            ...
            n = t.videoWidth(),
            i = t.videoHeight(),
            r = ah.getBoundingClientRect(t.el()),
            o = r.width,
            s = r.height,
            a = (o / s).toFixed(2),
            l = (n / i).toFixed(2),
            c = void 0,
            u = void 0;
            l < a ? (u = s, c = u * l) : l > a ? (c = o, u = c / l) : l == a && (c = o, u = s),
            e.containerLeft = (o - c) / 2 / o * 100,
            e.containerTop = (s - u) / 2 / s * 100,
            e.containerWidth = c / o * 100,
            e.containerHeight = u / s * 100
        },
        e.prototype.setStyle = function() {
            var t = this.containerElement,
            e = this.markContentElement,
            n = this.style;
            t.style.left = n.containerLeft + "%",
            t.style.top = n.containerTop + "%",
            t.style.width = n.containerWidth + "%",
            t.style.height = n.containerHeight + "%",
            t.style.display = e.style.display = n.display,
            t.style.visibility = e.style.visibility = n.visibility,
            t.style.opacity = e.style.opacity = n.opacity,
            t.style.position = e.style.position = n.position,
            t.style.margin = e.style.margin = n.margin,
            t.style.padding = e.style.padding = n.padding,
            e.style.left = n.contentLeft + "%",
            e.style.top = n.contentTop + "%",
            e.innerHTML = Pe(this.options.content)
        },
                ...
                l = function c() {
                    try {
                        if (!t.isPauseAnimation) {
                            var l = Math.min(1, t.options.speed || .2),
                            u = ah.getBoundingClientRect(i),
                            h = ah.getBoundingClientRect(r),
                            p = h.left - u.left,
                            d = h.top - u.top;
                            p += l * o * a,
                            d += l * s * (1 - a),
                            p + h.width > u.width ? (o = -1, a = Math.random()) : p < 0 && (o = 1, a = Math.random()),
                            d + h.height > u.height ? (s = -1, a = Math.random()) : d < 0 && (s = 1, a = Math.random()),
                            p = Math.min(u.width - h.width, p),
                            d = Math.min(u.height - h.height, d),
                            n.contentLeft = p / u.width * 100,
                            n.contentTop = d / u.height * 100,
                            t.setStyle()
                        }
                    } catch(f) {
                        e.$(".tcp-dynamic-watermark-container") ? e.$(".tcp-dynamic-watermark-content") || i.appendChild(r) : e.el().appendChild(i)
                    }
                    if (t.isStopAnimation) return t.isStopAnimation = !1,
    ...
    ce.registerPlugin("DynamicWatermark", ch);
    var uh = {
        enableStashBuffer: !1
    },
    hh = function() {
        function t(e, i, r) {
            ...
            ce.mergeOptions(uh, r));
            this.tech = i,
            s.on(n.Events.ERROR, ce.bind(this, this.onError));
            for (var a in n.Events) !
            function(t) {
                s.on(n.Events[t], ce.bind(o,
                function(e) {
                    this.onEvent(t, e)
                }))
            } (a);
        ...
        return t.prototype.onError = function(t, e, i) {
            var r = this.tech.player();
            t === n.ErrorTypes.NETWORK_ERROR && r.error({
                code: 2,
                source: i
            }),
            t === n.ErrorTypes.MEDIA_ERROR && r.error({
                code: 3,
                source: i
            })
        },
        t.prototype.onEvent = function(t, e) {
            this.tech.player().trigger({
                type: "FLVJS_EVENT",
                data: {
                    type: t,
                    data: e
    ...
    yh = {
        ...
        canHandleSource: function(t) {
            return ph.test(t.type) ? "probably": dh.test(t.src) || fh.test(t.src) ? "maybe": ""
        },
        handleSource: function(t, e, n) {
            return e.flvProvider && e.flvProvider.dispose(),
            e.flvProvider = new hh(t, e, n),
            e.flvProvider
        },
        canPlayType: function(t) {
            if (ph.test(t)) return "probably"
        }
    };
    Ge.mountFlvProvider = Xe,
    Xe();
    for (var gh = ce.getComponent("Tech"), vh = ce.dom, mh = ce.url, _h = ce.createTimeRange, bh = ce.mergeOptions, Th = tn && tn.navigator || {},
    Ch = function(t) {
        function e(n, i, r) {
            Zn(this, e);
            var o = ei(this, t.call(this, n, i, r));
            return i.source && o.ready(function() {
                this.setSource(i.source)
            },
            !0),
            i.startTime && o.ready(function() {
                this.load(),
                this.play(),
                this.currentTime(i.startTime)
            },
            !0),
            tn.videojs = tn.videojs || {},
            tn.videojs.Flash = tn.videojs.Flash || {},
            tn.videojs.Flash.onReady = e.onReady,
            tn.videojs.Flash.onEvent = e.onEvent,
        ...
        e.prototype.createEl = function() {
            var t = this.options_;
            t.swf || (t.swf = Ce("//imgcache.qq.com/open/qcloud/video/tcplayer/player.swf"));
            var n = t.techId,
            i = bh({
            ...
            t.attributes);
            return this.el_ = e.embed(t.swf, i, r, o),
            this.el_.tech = this,
            this.el_
        },
        e.prototype.play = function() {
        ...
        e.prototype.seekable = function() {
            var t = this.duration();
            return 0 === t ? _h() : _h(0, t)
        },
        e.prototype.buffered = function() {
            var t = this.el_.vjs_getProperty("buffered");
            return 0 === t.length ? _h() : _h(t[0][0], t[0][1])
        },
        e.prototype.supportsFullScreen = function() {
            return ! 1
        },
        ...
        e.prototype.getVideoPlaybackQuality = function() {
            ...
            return tn.performance && "function" == typeof tn.performance.now ? t.creationTime = tn.performance.now() : tn.performance && tn.performance.timing && "number" == typeof tn.performance.timing.navigationStart && (t.creationTime = tn.Date.now() - tn.performance.timing.navigationStart),
            t
        },
        e
    } (gh), Eh = ["rtmpConnection", "rtmpStream", "preload", "defaultPlaybackRate", "playbackRate", "autoplay", "loop", "controls", "volume", "muted", "defaultMuted"], wh = ["networkState", "readyState", "initialTime", "startOffsetTime", "paused", "ended", "videoWidth", "videoHeight"], kh = Ch.prototype, Sh = 0; Sh < Eh.length; Sh++) $e(Eh[Sh]),
    function(t) {
    ...
    for (var Ih = 0; Ih < wh.length; Ih++) $e(wh[Ih]);
    Ch.isSupported = function() {
        return Ch.version()[0] >= 10
    },
    gh.withSourceHandlers(Ch),
    Ch.nativeSourceHandler = {},
    Ch.nativeSourceHandler.canPlayType = function(t) {
        return t in Ch.formats ? "maybe": ""
    },
    Ch.nativeSourceHandler.canHandleSource = function(t, e) {
        var n = void 0;
        return n = t.type ? t.type.replace(/;.*/, "").toLowerCase() : function(t) {
            var e = mh.getFileExtension(t);
            return e ? "video/" + e: ""
        } (t.src),
        Ch.nativeSourceHandler.canPlayType(n)
    },
    Ch.nativeSourceHandler.handleSource = function(t, e, n) {
        e.setSrc(t.src)
    },
    Ch.nativeSourceHandler.dispose = function() {},
    Ch.registerSourceHandler(Ch.nativeSourceHandler),
    Ch.formats = {
        "video/flv": "FLV",
        "video/x-flv": "FLV",
        "video/mp4": "MP4",
    ...
    Ch.onReady = function(t) {
        var e = vh.$("#" + t),
        n = e && e.tech;
        n && n.el() && Ch.checkReady(n)
    },
    Ch.checkReady = function(t) {
        t.el() && (t.el().vjs_getProperty ? t.triggerReady() : this.setTimeout(function() {
            Ch.checkReady(t)
        },
        50))
    },
    Ch.onEvent = function(t, e) {
        var n = vh.$("#" + t).tech,
    ...
    Ch.version = function() {
        var t = "0,0,0";
        try {
            t = new tn.ActiveXObject("ShockwaveFlash.ShockwaveFlash").GetVariable("$version").replace(/\D+/g, ",").match(/^,?(.+),?$/)[1]
        } catch(e) {
            try {
                Th.mimeTypes["application/x-shockwave-flash"].enabledPlugin && (t = (Th.plugins["Shockwave Flash 2.0"] || Th.plugins["Shockwave Flash"]).description.replace(/\D+/g, ",").match(/^,?(.+),?$/)[1])
            } catch(e) {}
        }
        return t.split(",")
    },
    Ch.embed = function(t, e, n, i) {
        var r = Ch.getEmbedCode(t, e, n, i);
        return vh.createEl("div", {
            innerHTML: r
        }).childNodes[0]
    },
    Ch.getEmbedCode = function(t, e, n, i) {
        var r = "",
        o = "",
        s = "";
    ...
    function(t) {
        ...
        t.streamToParts = function(t) {
            ...
            var n = t.search(/&(?!\w+=)/),
            i = void 0;
            return - 1 !== n ? i = n + 1 : 0 === (n = i = t.lastIndexOf("/") + 1) && (n = i = t.length),
            e.connection = t.substring(0, n),
            e.stream = t.substring(i, t.length),
            e
        },
        ...
        t.rtmpSourceHandler.canHandleSource = function(e, n) {
            ...
            return i || (t.isStreamingSrc(e.src) ? "maybe": "")
        },
    ...
    gh.getTech("Flash") ? (ce.log.warn("Not using videojs-flash as it appears to already be registered"), ce.log.warn("videojs-flash should only be used with video.js@6 and above")) : ce.registerTech("Flash", Ch);
    var Ph = {},
    xh = /^(audio|video|application)\/(x-|vnd\.apple\.)?mpegurl/i;
    Ph.canPlayType = function(t) {
        return xh.test(t) ? "maybe": ""
    },
    Ph.canHandleSource = function(t, e) {
        return "maybe" === Ph.canPlayType(t.type)
    },
    Ph.handleSource = function(t, e, n) {
        e.setSrc(t.src)
    },
    Ph.dispose = function() {},
    ce.getTech("Flash").registerSourceHandler(Ph, 0),
    Ph.VERSION = "__VERSION__";
    var Dh = {
        Play: "播放",
        Pause: "暂停",
        LIVE: "直播",
    ...
    Mh = ce.log;
    if (Function.prototype.bind && "object" == ("undefined" == typeof console ? "undefined": Jn(console)) && "object" == Jn(console.log)) for (var Rh = ["log", "info", "warn", "error", "assert", "dir", "clear", "profile", "profileEnd"], Ah = 0; Ah < Rh.length; Ah++) {
        var Oh = Rh[Ah];
        console[Oh] = Function.prototype.call.bind(console[Oh], console)
    }
    return ce.addLanguage("zh-CN", Dh),
